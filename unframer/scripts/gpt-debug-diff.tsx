            ...
            messages: [
                {
                    ...
                    content:
                        'Find if there is any code behavior change in the following code diff generated by babel compact mode. If you find any change in how code is evaluated, return that snippet of code and only that. If you don\'t find anything, simply return "no issues" without any markdown or code snippet syntax, just reply with "no issues". Ignore any style differences like collapsed if statements. If there is a difference try to explain what changed in behavior and then write the diff snippet as is, copying exactly how it is in the original patch.',
                },
                {
                    role: 'user',
                    content: dedent`
