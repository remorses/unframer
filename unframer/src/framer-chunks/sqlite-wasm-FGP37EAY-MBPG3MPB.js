import {
  ...
  __privateSet,
  __publicField
} from "./chunk-WYG6DFEF.js";

// /:https://app.framerstatic.com/sqlite-wasm-FGP37EAY.mjs
...
var sqlite3InitModule = /* @__PURE__ */ (() => {
  var _scriptName = "https://app.framerstatic.com/sqlite-wasm-FGP37EAY.mjs";
  return function(moduleArg = {}) {
    ...
    var ENVIRONMENT_IS_WEB = typeof __unframerWindow == "object";
    ...
    function findWasmBinary() {
      ...
      return new URL("sqlite3.wasm", "https://app.framerstatic.com/sqlite-wasm-FGP37EAY.mjs").href;
    }
    var wasmBinaryFile;
    ...
    var FS_stdin_getChar = () => {
      if (!FS_stdin_getChar_buffer.length) {
        var result = null;
        if (typeof __unframerWindow != "undefined" && typeof __unframerWindow.prompt == "function") {
          result = __unframerWindow.prompt("Input: ");
          if (result !== null) {
            result += "\n";
          }
        } else {
    ...
    var getEnvStrings = () => {
      if (!getEnvStrings.strings) {
        var lang = (typeof __unframerNavigator == "object" && __unframerNavigator.languages && __unframerNavigator.languages[0] || "C").replace("-", "_") + ".UTF-8";
        var env = {
          USER: "web_user",
          LOGNAME: "web_user",
          PATH: "/",
    ...
    Module.runSQLite3PostLoadInit = function(EmscriptenModule) {
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
        const installOpfsVfs = function callee2(options) {
          ...
          } else if (!globalThis.FileSystemHandle || !globalThis.FileSystemDirectoryHandle || !globalThis.FileSystemFileHandle || !globalThis.FileSystemFileHandle.prototype.createSyncAccessHandle || !__unframerNavigator?.storage?.getDirectory) {
          ...
          const thePromise = new Promise(function(promiseResolve_, promiseReject_) {
            ...
            const thisThreadHasOPFS = () => {
              return globalThis.FileSystemHandle && globalThis.FileSystemDirectoryHandle && globalThis.FileSystemFileHandle && globalThis.FileSystemFileHandle.prototype.createSyncAccessHandle && __unframerNavigator?.storage?.getDirectory;
            };
            opfsUtil.metrics = {
              dump: function() {
                let k, n = 0, t = 0, w = 0;
            ...
            const W = new Worker(
              new URL("sqlite3-opfs-async-proxy.js", "https://app.framerstatic.com/sqlite-wasm-FGP37EAY.mjs")
            );
            setTimeout(() => {
                ...
                case "opfs-async-inited": {
                  ...
                  try {
                    ...
                    if (thisThreadHasOPFS()) {
                      __unframerNavigator.storage.getDirectory().then((d) => {
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
        ...
        class OpfsSAHPool {
          ...
          async reset(clearFiles) {
            await this.isReady;
            let h = await __unframerNavigator.storage.getDirectory();
            let prev, prevName;
        ...
        _dhVfsRoot = /* @__PURE__ */ new WeakMap();
        _dhOpaque = /* @__PURE__ */ new WeakMap();
        _dhVfsParent = /* @__PURE__ */ new WeakMap();
        _mapSAHToName = /* @__PURE__ */ new WeakMap();
        _mapFilenameToSAH = /* @__PURE__ */ new WeakMap();
        _availableSAH = /* @__PURE__ */ new WeakMap();
        _mapS3FileToOFile_ = /* @__PURE__ */ new WeakMap();
        _apBody = /* @__PURE__ */ new WeakMap();
        _dvBody = /* @__PURE__ */ new WeakMap();
        _cVfs = /* @__PURE__ */ new WeakMap();
        _verbosity = /* @__PURE__ */ new WeakMap();
        _OpfsSAHPool_instances = /* @__PURE__ */ new WeakSet();
        ...
        const apiVersionCheck = async () => {
          const dh = await __unframerNavigator.storage.getDirectory();
        ...
        sqlite3.installOpfsSAHPoolVfs = async function(options = /* @__PURE__ */ Object.create(null)) {
          ...
          if (!globalThis.FileSystemHandle || !globalThis.FileSystemDirectoryHandle || !globalThis.FileSystemFileHandle || !globalThis.FileSystemFileHandle.prototype.createSyncAccessHandle || !__unframerNavigator?.storage?.getDirectory) {
...
globalThis.sqlite3Worker1Promiser.defaultConfig = {
  worker: function() {
    return new Worker(
      new URL("sqlite3-worker1-bundler-friendly.mjs", "https://app.framerstatic.com/sqlite-wasm-FGP37EAY.mjs"),
      {
        type: "module"
      }
    );
