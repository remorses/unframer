...
import {
  createStore
} from "./chunk-ABL6Y7OR.js";

// /:https://framerusercontent.com/modules/ry9N7lTOKGZrBHcWBuZC/uV6Loz3nF9DVbHDWldqM/Theme_Switcher.js
...
function withSingleToggle(Component) {
  return (props) => {
    ...
    return /* @__PURE__ */ _jsx(Component, { ...props, variant: store.theme === "light" ? "Light" : "Dark", whileHover: { scale: 1.1 }, onClick: handleClick });
  };
}
