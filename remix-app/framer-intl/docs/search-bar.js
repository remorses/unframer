...
// https :https://framerusercontent.com/modules/9UAJj0iki6gynMc1A5PF/2i8ASklCIYeLLw5dtUs9/wvuAi9wiC.js
...
// https :https://framerusercontent.com/modules/6wAE2eMb2Tl3zrU7u4UL/HPzg2Uk7mwtBmDzvGbWF/Search.js
import { jsx as _jsx3, jsxs as _jsxs3, } from 'react/jsx-runtime';
import { createPortal, } from 'react-dom';
import { forwardRef as forwardRef2, useEffect as useEffect4, useRef as useRef3, useState as useState4, } from 'react';
import { AnimatePresence, motion as motion3, } from 'unframer';

// https :https://framerusercontent.com/modules/LV9trClbmNwd5PVj9l8y/L4rFqMGNzGSwRZpGTGF3/Icons.js
...
// https :https://framerusercontent.com/modules/tV9haTHllpHHc9Fjue2H/Xy775u0FJg3K1GQc1Cd9/SearchModal.js
import { jsx as _jsx2, jsxs as _jsxs2, } from 'react/jsx-runtime';

// https :https://framerusercontent.com/modules/MyBp84Z0p9nUcMimVMnY/y5F4AGWJ6syeuoB7ebKM/useSearch.js
import { useLocaleInfo, } from 'unframer';
import { clamp, } from 'unframer';
import { useEffect, useMemo, useState, } from 'react';

// https :https://framerusercontent.com/modules/3Xi2AslpcDRhfyCVPmx3/d0Oobr5BHnVqZJQyMdGn/storage.js
...
// https :https://framer.com/m/cache-YMiL.js@b9aplVZjN51x28yfNK16
...
// https :https://framerusercontent.com/modules/uU1mtMKXsrVAg8N5hW7w/PCK1x1QLNluYNoEoapwx/cachedIndex.js
var VERSION = 1;
...
// https :https://framerusercontent.com/modules/K9JZRwJcE6slDAf8rUmh/mJ54py1Ecnn1RoC4N1m4/fakeResults.js
var fakeResults = {
  '/': {
    version: 1,
...
// https :https://framerusercontent.com/modules/TwRgbWuhHeB95MPifel4/YW8Hlm59FG3PajbrVsaR/fuzzySearch.js
...
// https :https://framerusercontent.com/modules/MWsEnYfRnoOQq31DN4ql/C71JVnvNwV2CrPvApXBB/utils.js
...
function getFontFamily(theme,) {
  ...
  if ((_theme_inputFont = theme.inputFont) === null || _theme_inputFont === void 0 ? void 0 : _theme_inputFont.fontFamily) {
    return theme.inputFont.fontFamily;
  }
  if ((_theme_titleFont = theme.titleFont) === null || _theme_titleFont === void 0 ? void 0 : _theme_titleFont.fontFamily) {
    return theme.titleFont.fontFamily;
  }
  if ((_theme_subtitleFont = theme.subtitleFont) === null || _theme_subtitleFont === void 0 ? void 0 : _theme_subtitleFont.fontFamily) {
...
function useRawSearch(index, query, settings,) {
  const results = useMemo(() => {
    ...
    const results2 = Object.values(index,).map((item,) => {
      ...
      const title = (settings === null || settings === void 0 ? void 0 : settings.titleType) === SearchResultTitleType.Title
        ? item.title
        : heading
        ? heading
        : item.title;
  ...
  function setSearchIndex(index, options = { ignoreScope: false, },) {
    ...
    if (settings.urlScope && !options.ignoreScope) {
      scopedIndex = getIndexedScopedToUrl(
        index,
        settings.urlScope,
        activeLocale === null || activeLocale === void 0 ? void 0 : activeLocale.slug,
      );
...
// https :https://framerusercontent.com/modules/PJVBcBLmDteTEAZh3J9Z/keXJyjyE9VnzUcDMayjg/browser.js
var Browser;
(function (Browser2,) {
...
// https :https://framerusercontent.com/modules/tV9haTHllpHHc9Fjue2H/Xy775u0FJg3K1GQc1Cd9/SearchModal.js
import { clamp as clamp2, motion as motion2, useAnimate, } from 'unframer';

// https :https://framerusercontent.com/modules/Gzef0nFihI9m9vZG45th/lIUxbZcreiDm2GzUkt3y/useCallbackOnMouseMove.js
...
// https :https://framerusercontent.com/modules/eAnjm75CdfYT1Zz4BIaz/7KDSfnnyD1T3Ap75L4m8/scrollIntoView.js
...
// https :https://framerusercontent.com/modules/tV9haTHllpHHc9Fjue2H/Xy775u0FJg3K1GQc1Cd9/SearchModal.js
import { inferInitialRouteFromPath, useLocaleInfo as useLocaleInfo2, useRouter, } from 'unframer';
...
function ClearButton({ theme, type, onClick, text, },) {
  ...
  const iconOrText = shouldDisplayIcon
    ? /* @__PURE__ */ _jsx2(ClearIcon, {
      style: { color: theme.inputIconColor, width: theme.inputIconSize, height: theme.inputIconSize, },
    },)
    : text;
  return /* @__PURE__ */ _jsx2('div', {
    style: { flexShrink: 0, fontSize: theme && theme.titleFont && theme.titleFont.fontSize ? theme.titleFont.fontSize : 15, },
...
var Input = /* @__PURE__ */ forwardRef(function Input2(props, ref,) {
  ...
  const searchIcon = iconType === 'custom' && theme.inputIconImage
    ...
    : /* @__PURE__ */ _jsx2(SearchIcon, { color: theme.inputIconColor, width: theme.inputIconSize, height: theme.inputIconSize, },);
    ...
    children: [
      /* @__PURE__ */ _jsx2('div', {
        ...
        children: status === 'loading' && inputValue
          ? /* @__PURE__ */ _jsx2(SpinnerIcon, {
            color: theme.inputIconColor,
            backgroundColor: theme.backgroundColor,
            style: { height: theme && theme.inputIconSize, width: theme && theme.inputIconSize, },
          },)
          : searchIcon,
      },),
      ...
      _jsx2(ClearButton, { theme, type: props.clearButtonType, text: props.clearButtonText, onClick: handleClearClick, },),
    ],
  },);
},);
    ...
    children: /* @__PURE__ */ _jsxs2('li', {
      ...
      children: [
        ...
        /* @__PURE__ */ _jsxs2('div', {
          ...
          children: [
            /* @__PURE__ */ _jsx2('h3', { style: { ...resultTitle, ...theme.titleFont, lineHeight: '1.4em', }, children: title, },),
            /* @__PURE__ */ _jsxs2('p', {
              style: {
                margin: 0,
...
function LayoutContainer({ layoutType, theme, onKeyDown, onDismiss, children, modalOptions, },) {
  ...
  return /* @__PURE__ */ _jsxs2('div', {
    ...
    children: [
      layoutType === 'QuickMenu' && /* @__PURE__ */ _jsx2(QuickMenuSpacer, { onClick: onDismiss, },),
...
function ModalContainer({ layoutType, theme, children, heightIsStatic, heightTransition, heightDeps, },) {
  ...
  return /* @__PURE__ */ _jsx2('div', {
    ref: scope,
    role: 'dialog',
    className: layoutType === 'FixedTop' ? '__framer-max-height-80dvh' : void 0,
    style,
    children,
  },);
}
...
function SearchModal(props,) {
  ...
  const navigateTo = useCallback2(async (url,) => {
    ...
    try {
      ...
      const route = (_router_getRoute = router.getRoute) === null || _router_getRoute === void 0
        ? void 0
      ...
      await (route === null || route === void 0
        ...
        ? void 0
        : (_route_page_preload = _route_page.preload) === null || _route_page_preload === void 0
        ? void 0
        : _route_page_preload.call(_route_page,));
      (_router_navigate = router.navigate) === null || _router_navigate === void 0
        ? void 0
  ...
  const showDivider = Boolean(
    (deferredQuery.length > 0 && results.length > 0 || showNoResults) && status !== 'loading' && props.inputOptions &&
  ...
  return /* @__PURE__ */ _jsxs2(LayoutContainer, {
    layoutType,
    modalOptions,
    theme,
    ...
    onDismiss,
    children: [
      /* @__PURE__ */ _jsxs2(ModalContainer, {
        layoutType,
        theme,
        ...
        children: [
          ...
          showDivider && /* @__PURE__ */ _jsx2(Divider, { theme, type: inputOptions.dividerType, },),
          /* @__PURE__ */ _jsx2(ScrollView, {
            ref: scrollView,
            theme,
            children: /* @__PURE__ */ _jsxs2('ul', {
              'aria-live': 'polite',
              style: {
                display: 'flex',
                flexDirection: 'column',
              ...
              children: [
                results.map((result, index,) => {
                  ...
                  return /* @__PURE__ */ _jsx2(ResultRow, {
                ...
                showNoResults && /* @__PURE__ */ _jsx2('li', {
                  style: {
      ...
      /* @__PURE__ */ _jsx2(StatusMessage, { status, layoutType, theme, },),
    ],
  },);
}

// https :https://framerusercontent.com/modules/hqEf5wXaAewP8VPuaZ98/5A0QGVeEr2cwheQpIuEG/useViewportSizeState.js
...
var EntryPoint = withCSS(function EntryPoint2(props,) {
  ...
  const baseInputFontSize = ((_props_inputOptions = props.inputOptions) === null || _props_inputOptions === void 0
      ? void 0
      : (_props_inputOptions_inputFont = _props_inputOptions.inputFont) === null || _props_inputOptions_inputFont === void 0
      ? void 0
  ...
  const theme = {
    ...
    titleFont: ((_props_resultOptions = props.resultOptions) === null || _props_resultOptions === void 0
        ? void 0
        : _props_resultOptions.titleFont) && !isEmptyObject(props.resultOptions.titleFont,)
      ? props.resultOptions.titleFont
      : { fontSize: 14, fontFamily: DEFAULT_FONT_FAMILY, fontWeight: 500, },
    subtitleFont:
      ((_props_resultOptions_subtitleOptions = props.resultOptions.subtitleOptions) === null ||
            _props_resultOptions_subtitleOptions === void 0
          ? void 0
          : _props_resultOptions_subtitleOptions.subtitleFont) && !isEmptyObject(props.resultOptions.subtitleOptions.subtitleFont,)
        ? props.resultOptions.subtitleOptions.subtitleFont
        : { fontSize: 12, fontFamily: DEFAULT_FONT_FAMILY, fontWeight: 500, },
    inputFont:
      ((_props_inputOptions1 = props.inputOptions) === null || _props_inputOptions1 === void 0 ? void 0 : _props_inputOptions1.inputFont) &&
        !isEmptyObject(props.inputOptions.inputFont,)
        ? props.inputOptions.inputFont
        : { fontSize: 16, fontFamily: DEFAULT_FONT_FAMILY, fontWeight: 500, },
  ...
  return /* @__PURE__ */ _jsxs3('div', {
    style: { ...containerStyle, ...props.style, pointerEvents: isOverLimit ? 'none' : 'auto', opacity: isOverLimit ? 0.4 : 1, },
    children: [
      /* @__PURE__ */ _jsx3('button', {
        ...
        onClick: handleClick,
        children: props.iconType === SearchIconType.Custom && theme.entryIconImage
          ? /* @__PURE__ */ _jsx3('img', {
          ...
          : /* @__PURE__ */ _jsx3(SearchIcon, { color: theme.entryIconColor, width: theme.entryIconSize, height: theme.entryIconSize, },),
      },),
      /* @__PURE__ */ _jsx3(AnimatePresence, {
        children: isOpen && !isOnCanvas && /* @__PURE__ */
          _jsx3(Overlay, {
            ref: overlay,
            layoutType,
            urlScope: props.urlScope,
...
addPropertyControls(EntryPoint, {
    ...
    controls: {
      iconOptions: {
        ...
        controls: {
          ...
          iconSize: { title: 'Icon Size', type: ControlType.Number, displayStepper: true, defaultValue: 18, min: 0, max: 100, },
        },
      },
      inputFont: {
        title: 'Font',
      ...
      textColor: { title: 'Color', type: ControlType.Color, defaultValue: '#333', },
      placeholderOptions: {
        title: 'Placeholder',
        type: ControlType.Object,
        buttonTitle: 'Color, Text',
        controls: {
          placeholderText: { title: 'Text', type: ControlType.String, defaultValue: 'Search...', },
          placeholderColor: { title: 'Color', type: ControlType.Color, defaultValue: 'rgba(0,0,0,0.4)', },
        },
      },
      dividerType: {
        title: 'Divider',
  ...
  modalOptions: {
    ...
    controls: {
      ...
      heightTransition: {
        ...
        hidden: ({ heightIsStatic, layoutType, },) => layoutType !== SearchLayoutType.QuickMenu || heightIsStatic,
      },
      borderRadius: {
        title: 'Radius',
        type: ControlType.Number,
      ...
      backgroundColor: { title: 'Background', type: ControlType.Color, defaultValue: '#FFF', },
      ...
      [animationKeyFromLayout(SearchLayoutType.FixedTop,)]: {
        ...
        optional: true,
        controls: {
          opacity: { type: ControlType.Number, defaultValue: 0.8, step: 0.1, min: 0, max: 1, },
  ...
  resultOptions: {
    ...
    controls: {
      ...
      titleColor: { title: 'Color', type: ControlType.Color, defaultValue: '#333', },
      titleType: {
        title: 'Content',
        type: ControlType.Enum,
      ...
      subtitleOptions: {
        ...
        controls: {
          ...
          subtitleColor: { title: 'Color', type: ControlType.Color, defaultValue: 'rgba(0, 0, 0, 0.4)', },
          subtitleType: {
            title: 'Content',
            type: ControlType.Enum,
  ...
  backdropOptions: {
    ...
    controls: {
      backgroundColor: { title: 'Color', type: ControlType.Color, defaultValue: 'rgba(0, 0, 0, 0.8)', },
      zIndex: { title: 'Z Index', type: ControlType.Number, defaultValue: 10, displayStepper: true, min: 0, max: 10, },
      transition: { type: ControlType.Transition, },
    },
  },
},);
...
var Component = /* @__PURE__ */ React2.forwardRef(function (props, ref,) {
  ...
  const {
    ...
    setVariant,
    variants,
  } = useVariantState({ cycleOrder, defaultVariant: 'jsVKEKG4s', variant, variantClassNames, },);
    ...
    children: /* @__PURE__ */ _jsx4(Variants, {
      ...
      children: /* @__PURE__ */ _jsx4(Transition, {
        ...
        children: /* @__PURE__ */ _jsx4(motion4.div, {
          ...restProps,
          ...gestureHandlers,
          className: cx(serializationHash, ...sharedStyleClassNames, 'framer-1rtq0nx', className2, classNames,),
          'data-border': true,
          ...
          ...addPropertyOverrides({ lBkI6MWTM: { 'data-framer-name': 'Mobile', }, }, baseVariant, gestureVariant,),
              ...
              /* @__PURE__ */ _jsx4(ComponentViewportProvider, {
                children: /* @__PURE__ */ _jsx4(motion4.div, {
                  ...
                  children: /* @__PURE__ */ _jsx4(stdin_default, {
                    ...
                    iconImage: addImageAlt({ src: 'https://framerusercontent.com/images/LcSrauRN6S5dbcfiUyHSBISkE.svg', }, '',),
                    iconSize: 20,
                    iconType: 'custom',
                    id: 'G38UBLMGf',
                    inputOptions: {
                    ...
                    modalOptions: {
                      ...
                      heightTransition: { damping: 60, stiffness: 800, type: 'spring', },
                      layoutType: 'QuickMenu',
                      shadow: { blur: 40, color: 'rgba(0, 0, 0, 0.2)', spread: 0, x: 0, y: 20, },
                      top: 0,
                      width: 500,
                    },
                    resultOptions: {
              ...
              /* @__PURE__ */ _jsxs4(motion4.div, {
                ...
                children: [
                  /* @__PURE__ */ _jsx4(SVG, {
                    ...
                    fill: 'var(--token-944d416b-60ec-406a-99c8-94ca89212156, rgb(169, 169, 169))',
                    intrinsicHeight: 24,
                    intrinsicWidth: 24,
                    layoutDependency,
                    layoutId: 'tqZ40nGhR',
...
addPropertyControls2(FramerwvuAi9wiC, {
  variant: { options: ['jsVKEKG4s', 'lBkI6MWTM',], optionTitles: ['Desktop', 'Mobile',], title: 'Variant', type: ControlType2.Enum, },
},);
addFonts(FramerwvuAi9wiC, [
  {
    ...
    fonts: [{
      ...
      style: 'normal',
      url:
        'https://framerusercontent.com/third-party-assets/fontshare/wf/3RZHWSNONLLWJK3RLPEKUZOMM56GO4LJ/BPDRY7AHVI3MCDXXVXTQQ76H3UXA63S3/SB2OEB6IKZPRR6JT4GFJ2TFT6HBB6AZN.woff2',
      weight: '500',
    }, {
      family: 'Inter',
      source: 'framer',
