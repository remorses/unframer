...
// /:https://framerusercontent.com/modules/9UAJj0iki6gynMc1A5PF/2i8ASklCIYeLLw5dtUs9/wvuAi9wiC.js
...
var variantClassNames = { jsVKEKG4s: "framer-v-1rtq0nx", lBkI6MWTM: "framer-v-ldyh1u" };
...
var humanReadableVariantMap = { Desktop: "jsVKEKG4s", Mobile: "lBkI6MWTM" };
var getProps = ({ height, id, width, ...props }) => {
  var _humanReadableVariantMap_props_variant, _ref;
  return { ...props, variant: (_ref = (_humanReadableVariantMap_props_variant = humanReadableVariantMap[props.variant]) !== null && _humanReadableVariantMap_props_variant !== void 0 ? _humanReadableVariantMap_props_variant : props.variant) !== null && _ref !== void 0 ? _ref : "jsVKEKG4s" };
};
...
var Component = /* @__PURE__ */ React2.forwardRef(function(props, ref) {
  ...
  const { baseVariant, classNames, clearLoadingGesture, gestureHandlers, gestureVariant, isLoading, setGestureState, setVariant, variants } = useVariantState({ cycleOrder, defaultVariant: "jsVKEKG4s", variant, variantClassNames });
  const layoutDependency = createLayoutDependency(props, variants);
  const ref1 = React2.useRef(null);
  const defaultLayoutId = React2.useId();
  const sharedStyleClassNames = [className];
  const componentViewport = useComponentViewport();
  return /* @__PURE__ */ _jsx4(LayoutGroup, { id: layoutId !== null && layoutId !== void 0 ? layoutId : defaultLayoutId, children: /* @__PURE__ */ _jsx4(Variants, { animate: variants, initial: false, children: /* @__PURE__ */ _jsx4(Transition, { value: transition1, children: /* @__PURE__ */ _jsx4(motion4.div, { ...restProps, ...gestureHandlers, className: cx(serializationHash, ...sharedStyleClassNames, "framer-1rtq0nx", className2, classNames), "data-border": true, "data-framer-name": "Desktop", layoutDependency, layoutId: "jsVKEKG4s", ref: ref !== null && ref !== void 0 ? ref : ref1, style: { "--border-bottom-width": "1px", "--border-color": "var(--token-1691cb44-c002-4542-9545-8a0801f91af2, rgb(231, 231, 231))", "--border-left-width": "0px", "--border-right-width": "0px", "--border-style": "solid", "--border-top-width": "0px", backgroundColor: "var(--token-f1edbbf0-4dde-4043-88fc-e447b2e4f208, rgb(255, 255, 255))", ...style }, ...addPropertyOverrides({ lBkI6MWTM: { "data-framer-name": "Mobile" } }, baseVariant, gestureVariant), children: /* @__PURE__ */ _jsxs4(motion4.div, { className: "framer-14gp762", "data-framer-name": "Search Container", layoutDependency, layoutId: "AOFl7NI65", children: [/* @__PURE__ */ _jsx4(ComponentViewportProvider, { children: /* @__PURE__ */ _jsx4(motion4.div, { className: "framer-1s197uu-container", layoutDependency, layoutId: "G38UBLMGf-container", style: { opacity: 0 }, children: /* @__PURE__ */ _jsx4(stdin_default, { backdropOptions: { backgroundColor: "rgba(0, 0, 0, 0.3)", transition: { damping: 60, delay: 0, duration: 0.3, ease: [0.44, 0, 0.56, 1], mass: 1, stiffness: 500, type: "spring" }, zIndex: 10 }, height: "100%", iconColor: "var(--token-0903d63a-94ee-49f4-896e-eb837e1f22c9, rgb(160, 160, 160))", iconImage: addImageAlt({ src: "https://framerusercontent.com/images/LcSrauRN6S5dbcfiUyHSBISkE.svg" }, ""), iconSize: 20, iconType: "custom", id: "G38UBLMGf", inputOptions: { clearButtonText: "Clear", clearButtonType: "icon", dividerType: "fullWidth", iconOptions: { iconColor: "var(--token-0903d63a-94ee-49f4-896e-eb837e1f22c9, rgb(160, 160, 160))", iconImage: addImageAlt({ src: "https://framerusercontent.com/images/LcSrauRN6S5dbcfiUyHSBISkE.svg" }, ""), iconSize: 20, iconType: "custom" }, inputFont: { fontFamily: '"General Sans", "General Sans Placeholder", sans-serif', fontSize: "20px", fontStyle: "normal", fontWeight: 500 }, placeholderOptions: { placeholderColor: "var(--token-0903d63a-94ee-49f4-896e-eb837e1f22c9, rgb(160, 160, 160))", placeholderText: "Search Docs..." }, textColor: "var(--token-6fff741a-90b6-438e-9423-1f7c07944681, rgb(17, 17, 17))" }, layoutId: "G38UBLMGf", modalOptions: { backgroundColor: "var(--token-74b02f5b-961b-49eb-8e13-4477bd831f3e, rgb(250, 250, 251))", borderRadius: 18, heightIsStatic: false, heightTransition: { damping: 60, stiffness: 800, type: "spring" }, layoutType: "QuickMenu", shadow: { blur: 40, color: "rgba(0, 0, 0, 0.2)", spread: 0, x: 0, y: 20 }, top: 0, width: 500 }, resultOptions: { itemType: "contained", subtitleOptions: { subtitleColor: "var(--token-95cb0a67-053e-4ab2-a5d0-7294f60d31fe, rgb(136, 136, 138))", subtitleFont: { fontFamily: '"General Sans", "General Sans Placeholder", sans-serif', fontSize: "14px", fontStyle: "normal", fontWeight: 500 }, subtitleType: "description" }, titleColor: "var(--token-6fff741a-90b6-438e-9423-1f7c07944681, rgb(17, 17, 17))", titleFont: { fontFamily: '"General Sans", "General Sans Placeholder", sans-serif', fontSize: "16px", fontStyle: "normal", fontWeight: 500 }, titleType: "h1" }, style: { height: "100%", width: "100%" }, width: "100%", ...addPropertyOverrides({ lBkI6MWTM: { backdropOptions: { backgroundColor: "rgba(0, 0, 0, 0.3)", transition: { damping: 60, delay: 0, duration: 0.3, ease: [0.44, 0, 0.56, 1], mass: 1, stiffness: 800, type: "spring" }, zIndex: 2 }, inputOptions: { clearButtonText: "Clear", clearButtonType: "icon", dividerType: "fullWidth", iconOptions: { iconColor: "var(--token-0903d63a-94ee-49f4-896e-eb837e1f22c9, rgb(160, 160, 160))", iconImage: addImageAlt({ src: "https://framerusercontent.com/images/LcSrauRN6S5dbcfiUyHSBISkE.svg" }, ""), iconSize: 20, iconType: "custom" }, inputFont: { fontFamily: '"General Sans", "General Sans Placeholder", sans-serif', fontSize: "20px", fontStyle: "normal", fontWeight: 500 }, placeholderOptions: { placeholderColor: "var(--token-0903d63a-94ee-49f4-896e-eb837e1f22c9, rgb(160, 160, 160))", placeholderText: "Search Docs\u2026" }, textColor: "var(--token-6fff741a-90b6-438e-9423-1f7c07944681, rgb(17, 17, 17))" }, modalOptions: { backgroundColor: "var(--token-74b02f5b-961b-49eb-8e13-4477bd831f3e, rgb(250, 250, 251))", borderRadius: 18, FixedTopAnimation: { opacity: 0.8, transition: { damping: 60, delay: 0, duration: 0.3, ease: [0.44, 0, 0.56, 1], mass: 1, stiffness: 500, type: false }, y: 0 }, heightIsStatic: false, heightTransition: { damping: 60, stiffness: 800, type: "spring" }, layoutType: "FixedTop", shadow: { blur: 40, color: "rgba(0, 0, 0, 0.2)", spread: 0, x: 0, y: 20 }, top: 70, width: 500 } } }, baseVariant, gestureVariant) }) }) }), /* @__PURE__ */ _jsxs4(motion4.div, { className: "framer-19moii3", "data-framer-name": "Search Input", layoutDependency, layoutId: "dxNGQGLEY", children: [/* @__PURE__ */ _jsx4(SVG, { className: "framer-12hme5w", "data-framer-name": "graphic", fill: "var(--token-944d416b-60ec-406a-99c8-94ca89212156, rgb(169, 169, 169))", intrinsicHeight: 24, intrinsicWidth: 24, layoutDependency, layoutId: "tqZ40nGhR", svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6"><path fill-rule="evenodd" d="M10.5 3.75a6.75 6.75 0 1 0 0 13.5 6.75 6.75 0 0 0 0-13.5ZM2.25 10.5a8.25 8.25 0 1 1 14.59 5.28l4.69 4.69a.75.75 0 1 1-1.06 1.06l-4.69-4.69A8.25 8.25 0 0 1 2.25 10.5Z" clip-rule="evenodd"/></svg>', withExternalLayout: true }), /* @__PURE__ */ _jsx4(RichText, { __fromCanvasComponent: true, children: /* @__PURE__ */ _jsx4(React2.Fragment, { children: /* @__PURE__ */ _jsx4(motion4.p, { className: "framer-styles-preset-17qeria", "data-styles-preset": "vSuRg5Prj", style: { "--framer-text-color": "var(--extracted-r6o4lv, var(--token-944d416b-60ec-406a-99c8-94ca89212156, rgba(15, 15, 15, 0.5)))" }, children: "Search Docs\u2026" }) }), className: "framer-8oasec", fonts: ["Inter"], layoutDependency, layoutId: "Vyk5gzfJN", style: { "--extracted-r6o4lv": "var(--token-944d416b-60ec-406a-99c8-94ca89212156, rgba(15, 15, 15, 0.5))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--framer-paragraph-spacing": "0px" }, verticalAlignment: "top", withExternalLayout: true })] })] }) }) }) }) });
});
