...
import { addFonts, addPropertyControls as addPropertyControls2, ComponentViewportProvider, ControlType as ControlType2, cx, getFonts, getFontsFromSharedStyle, RichText, SVG, useComponentViewport, useLocaleInfo as useLocaleInfo3, useVariantState, withCSS as withCSS2 } from "unframer";
...
function SearchIcon(props) {
  return <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 256 256"} width={props.width} height={props.height} style={{
    ...props.style,
    color: props.color
  }}><path d={"M232.49,215.51,185,168a92.12,92.12,0,1,0-17,17l47.53,47.54a12,12,0,0,0,17-17ZM44,112a68,68,0,1,1,68,68A68.07,68.07,0,0,1,44,112Z"} fill={"currentColor"} /></svg>;
}
function ClearIcon(props) {
  return <svg xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 256 256"} {...props}><rect width={"256"} height={"256"} fill={"none"} /><path d={"M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm37.66,130.34a8,8,0,0,1-11.32,11.32L128,139.31l-26.34,26.35a8,8,0,0,1-11.32-11.32L116.69,128,90.34,101.66a8,8,0,0,1,11.32-11.32L128,116.69l26.34-26.35a8,8,0,0,1,11.32,11.32L139.31,128Z"} fill={"currentColor"} /></svg>;
}
...
function scrollIntoView(targetElement, scrollElement, {
  offsetTop,
  offsetBottom
}) {
...
// /:https://framerusercontent.com/modules/tV9haTHllpHHc9Fjue2H/Xy775u0FJg3K1GQc1Cd9/SearchModal.js
import { useLocaleInfo as useLocaleInfo2, useRouter, inferInitialRouteFromPath } from "unframer";
...
function ClearButton({
  ...
  const iconOrText = shouldDisplayIcon ? <ClearIcon style={{
  ...
  }}><button className={"__framer-search-clear-button"} onClick={onClick} style={{
      fontFamily: "inherit",
      border: "none",
      background: "none",
      cursor: "pointer",
...
var Input = /* @__PURE__ */forwardRef(function Input2(props, ref) {
  ...
  const searchIcon = iconType === "custom" && theme.inputIconImage ? <img alt={"icon alongside the Site Search input"} src={theme.inputIconImage.src} width={theme.inputIconSize} height={theme.inputIconSize} /> : <SearchIcon color={theme.inputIconColor} width={theme.inputIconSize} height={theme.inputIconSize} />;
  return <div role={"search"} style={{
    ...inputContainerStyle,
    ...
    touchAction: "none"
  }} onClick={handleInputClick}><div style={{
      flexShrink: 0,
      display: "flex"
    }}>{status === "loading" && inputValue ? <SpinnerIcon color={theme.inputIconColor} backgroundColor={theme.backgroundColor} style={{
        height: theme && theme.inputIconSize,
        width: theme && theme.inputIconSize
      }} /> : searchIcon}</div><input ref={inputRef} spellCheck={false} autoFocus={autofocus} style={{
      ...inputStyle,
    ...
    }} placeholder={placeholder} value={inputValue} onChange={() => setInputValue(inputRef.current.value)} />{showClearButton && <ClearButton theme={theme} type={props.clearButtonType} text={props.clearButtonText} onClick={handleClearClick} />}</div>;
});
...
var ResultRow = /* @__PURE__ */React.memo(/* @__PURE__ */React.forwardRef(function ResultRow2(props, ref) {
  ...
  return <a ref={ref} style={{
    textDecoration: "none"
  }} href={result.url} onClick={handleClick} onMouseMove={handleMouseMove} onMouseDown={focusTrap} onPointerDown={event => onPointerDown(event, index)}><li style={{
      ...resultContainer,
      ...style,
      ...
      paddingRight: theme && theme.horizontalSpacing
        ...
        gap: 4
          ...
          lineHeight: "1.4em"
        }}>{localStorageDebugFlag ? score : ""}{" "}{subtitleText}</p></div></li></a>;
}));
...
function LayoutContainer({
  ...
  return <div style={style} onKeyDown={onKeyDown} onClick={event => event.stopPropagation()}>{layoutType === "QuickMenu" && <QuickMenuSpacer onClick={onDismiss} />}<motion2.div initial={containerAnimation} animate={{
      opacity: 1,
      scale: 1,
      x: 0,
      y: 0,
      rotate: 0
    }} transition={containerAnimation ? containerAnimation.transition : void 0} exit={{
      opacity: 0,
      transition: {
        duration: 0
      }
    }} style={innerStyle}>{children}</motion2.div></div>;
}
function ModalContainer({
  ...
  return <div ref={scope} role={"dialog"} className={layoutType === "FixedTop" ? "__framer-max-height-80dvh" : void 0} style={style}>{children}</div>;
}
...
function SearchModal(props) {
  ...
  const navigateTo = useCallback2(async url => {
    ...
    try {
      ...
      const {
        routeId,
        pathVariables
      } = inferInitialRouteFromPath(router.routes, url);
  ...
  return <LayoutContainer layoutType={layoutType} modalOptions={modalOptions} theme={theme} onKeyDown={handleKeyDown} onDismiss={onDismiss}><ModalContainer layoutType={layoutType} theme={theme} heightIsStatic={modalOptions.heightIsStatic} heightTransition={modalOptions.heightTransition} heightDeps={[results.length, showNoResults]}><Input autofocus={true} ref={input} onChange={setQuery} value={query} theme={theme} status={status} iconType={inputOptions.iconOptions.iconType} placeholder={inputOptions.placeholderOptions.placeholderText} clearButtonType={inputOptions ? inputOptions.clearButtonType : void 0} clearButtonText={inputOptions.clearButtonText} />{showDivider && <Divider theme={theme} type={inputOptions.dividerType} />}<ScrollView ref={scrollView} theme={theme}><ul aria-live={"polite"} style={{
          display: "flex",
          flexDirection: "column",
          width: `calc(100% - ${theme.scrollBarWidth}px)`,
          padding: 0,
          ...
          margin: 0
            ...
            height: "Sidebar" ? "100%" : "auto"
              ...
              color: theme.subtitleColor,
              ...theme.titleFont
            }}>{"No results"}</h3></li>}</ul></ScrollView></ModalContainer><StatusMessage status={status} layoutType={layoutType} theme={theme} /></LayoutContainer>;
}
...
var Overlay = /* @__PURE__ */forwardRef2(function Overlay2(props, ref) {
  ...
  return /* @__PURE__ */createPortal(<div ref={ref} className={"__framer-search-modal-container"} role={"presentation"} style={{
    ...backdropStyles,
    zIndex: props.backdropOptions.zIndex,
    justifyContent: layoutType === SearchLayoutType.Sidebar ? "flex-start" : "center"
  }} onClick={onDismiss}><motion3.div role={"presentation"} initial={{
      opacity: 0
    }} animate={{
      opacity: 1
    }} exit={{
    ...
    }} transition={theme.overlayTransition} style={{
      top: 0,
      left: 0,
      right: 0,
      bottom: 0,
    ...
    }} /><SearchModal urlScope={props.urlScope} layoutType={layoutType} inputOptions={props.inputOptions} resultOptions={props.resultOptions} modalOptions={props.modalOptions} backdropOptions={props.backdropOptions} theme={props.theme} onDismiss={onDismiss} /></div>, document.body);
});
var backdropStyles = {
  width: "100%",
  boxSizing: "border-box",
...
var EntryPoint = withCSS(function EntryPoint2(props) {
  ...
  const theme = {
    ...
    titleFont: ((_props_resultOptions = props.resultOptions) === null || _props_resultOptions === void 0 ? void 0 : _props_resultOptions.titleFont) && !isEmptyObject(props.resultOptions.titleFont) ? props.resultOptions.titleFont : {
      fontSize: 14,
      fontFamily: DEFAULT_FONT_FAMILY,
      fontWeight: 500
    },
    subtitleFont: ((_props_resultOptions_subtitleOptions = props.resultOptions.subtitleOptions) === null || _props_resultOptions_subtitleOptions === void 0 ? void 0 : _props_resultOptions_subtitleOptions.subtitleFont) && !isEmptyObject(props.resultOptions.subtitleOptions.subtitleFont) ? props.resultOptions.subtitleOptions.subtitleFont : {
      fontSize: 12,
      fontFamily: DEFAULT_FONT_FAMILY,
      fontWeight: 500
    },
    inputFont: ((_props_inputOptions1 = props.inputOptions) === null || _props_inputOptions1 === void 0 ? void 0 : _props_inputOptions1.inputFont) && !isEmptyObject(props.inputOptions.inputFont) ? props.inputOptions.inputFont : {
      fontSize: 16,
      fontFamily: DEFAULT_FONT_FAMILY,
      fontWeight: 500
    },
  ...
  return <div style={{
    ...
    opacity: isOverLimit ? 0.4 : 1
  }}><button aria-label={"Search Icon"} style={{
      width: "100%",
      height: "100%",
      display: "flex",
      alignItems: "center",
      ...
      outline: "inherit",
      padding: 0
    }} onClick={handleClick}>{props.iconType === SearchIconType.Custom && theme.entryIconImage ? <img alt={"icon entry point for Site Search"} src={theme.entryIconImage.src} width={theme.entryIconSize} height={theme.entryIconSize} /> : <SearchIcon color={theme.entryIconColor} width={theme.entryIconSize} height={theme.entryIconSize} />}</button><AnimatePresence>{isOpen && !isOnCanvas && <Overlay ref={overlay} layoutType={layoutType} urlScope={props.urlScope} inputOptions={props.inputOptions} resultOptions={props.resultOptions} backdropOptions={props.backdropOptions} modalOptions={props.modalOptions} theme={theme} onDismiss={() => setIsOpen(false)} />}</AnimatePresence></div>;
}, [
...
var getProps = ({
  ...
  return {
    ...props,
    variant: humanReadableVariantMap[props.variant] ?? props.variant ?? "jsVKEKG4s"
  };
};
...
var Component = /* @__PURE__ */React2.forwardRef(function (props, ref) {
  ...
  return <LayoutGroup id={layoutId ?? defaultLayoutId}><Variants animate={variants} initial={false}><Transition value={transition1}><motion4.div {...restProps} {...gestureHandlers} className={cx(serializationHash, ...sharedStyleClassNames, "framer-1rtq0nx", className2, classNames)} data-border={true} data-framer-name={"Desktop"} layoutDependency={layoutDependency} layoutId={"jsVKEKG4s"} ref={ref ?? ref1} style={{
          ...
          lBkI6MWTM: {
            "data-framer-name": "Mobile"
        ...
        }, baseVariant, gestureVariant)}><motion4.div className={"framer-14gp762"} data-framer-name={"Search Container"} layoutDependency={layoutDependency} layoutId={"AOFl7NI65"}><ComponentViewportProvider><motion4.div className={"framer-1s197uu-container"} layoutDependency={layoutDependency} layoutId={"G38UBLMGf-container"} style={{
                opacity: 0
              }}>_jsx4(stdin_default, {
                  backdropOptions: {
                  ...
                  height: "100%",
                  iconColor: "var(--token-0903d63a-94ee-49f4-896e-eb837e1f22c9, rgb(160, 160, 160))",
                  ...
                  inputOptions: {
                    ...
                    placeholderOptions: {
                      placeholderColor: "var(--token-0903d63a-94ee-49f4-896e-eb837e1f22c9, rgb(160, 160, 160))",
                      placeholderText: "Search Docs..."
                    },
                    textColor: "var(--token-6fff741a-90b6-438e-9423-1f7c07944681, rgb(17, 17, 17))"
                  },
                  layoutId: "G38UBLMGf",
                  modalOptions: {
                    backgroundColor: "var(--token-74b02f5b-961b-49eb-8e13-4477bd831f3e, rgb(250, 250, 251))",
                    borderRadius: 18,
                  ...
                  resultOptions: {
                    itemType: "contained",
                    subtitleOptions: {
                      subtitleColor: "var(--token-95cb0a67-053e-4ab2-a5d0-7294f60d31fe, rgb(136, 136, 138))",
                      subtitleFont: {
                        fontFamily: '"General Sans", "General Sans Placeholder", sans-serif',
                        fontSize: "14px",
                        fontStyle: "normal",
                    ...
                    titleColor: "var(--token-6fff741a-90b6-438e-9423-1f7c07944681, rgb(17, 17, 17))",
                    titleFont: {
                      fontFamily: '"General Sans", "General Sans Placeholder", sans-serif',
                      fontSize: "16px",
                      fontStyle: "normal",
                ...
                })</motion4.div></ComponentViewportProvider><motion4.div className={"framer-19moii3"} data-framer-name={"Search Input"} layoutDependency={layoutDependency} layoutId={"dxNGQGLEY"}><SVG className={"framer-12hme5w"} data-framer-name={"graphic"} fill={"var(--token-944d416b-60ec-406a-99c8-94ca89212156, rgb(169, 169, 169))"} intrinsicHeight={24} intrinsicWidth={24} layoutDependency={layoutDependency} layoutId={"tqZ40nGhR"} svg={'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6"><path fill-rule="evenodd" d="M10.5 3.75a6.75 6.75 0 1 0 0 13.5 6.75 6.75 0 0 0 0-13.5ZM2.25 10.5a8.25 8.25 0 1 1 14.59 5.28l4.69 4.69a.75.75 0 1 1-1.06 1.06l-4.69-4.69A8.25 8.25 0 0 1 2.25 10.5Z" clip-rule="evenodd"/></svg>'} withExternalLayout={true} /><RichText __fromCanvasComponent={true} className={"framer-8oasec"} fonts={["Inter"]} layoutDependency={layoutDependency} layoutId={"Vyk5gzfJN"} style={{
                "--extracted-r6o4lv": "var(--token-944d416b-60ec-406a-99c8-94ca89212156, rgba(15, 15, 15, 0.5))",
                "--framer-link-text-color": "rgb(0, 153, 255)",
                "--framer-link-text-decoration": "underline",
                "--framer-paragraph-spacing": "0px"
              }} verticalAlignment={"top"} withExternalLayout={true}><React2.Fragment><motion4.p className={"framer-styles-preset-17qeria"} data-styles-preset={"vSuRg5Prj"} style={{
                    "--framer-text-color": "var(--extracted-r6o4lv, var(--token-944d416b-60ec-406a-99c8-94ca89212156, rgba(15, 15, 15, 0.5)))"
                  }}>{"Search Docs\u2026"}</motion4.p></React2.Fragment></RichText></motion4.div></motion4.div></motion4.div></Transition></Variants></LayoutGroup>;
});
var css2 = ["@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }", ".framer-ORLXf.framer-11ewss7, .framer-ORLXf .framer-11ewss7 { display: block; }", ".framer-ORLXf.framer-1rtq0nx { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; gap: 20px; height: 72px; justify-content: flex-start; overflow: hidden; padding: 0px 24px 0px 0px; position: relative; width: 737px; }", ".framer-ORLXf .framer-14gp762 { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: 100%; justify-content: center; overflow: hidden; padding: 24px; position: relative; width: 1px; }", ".framer-ORLXf .framer-1s197uu-container { bottom: 0px; cursor: text; flex: none; left: 0px; position: absolute; right: 0px; top: 0px; z-index: 1; }", ".framer-ORLXf .framer-19moii3 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 12px; height: 24px; justify-content: flex-start; overflow: hidden; padding: 0px; position: relative; width: 391px; }", ".framer-ORLXf .framer-12hme5w { aspect-ratio: 1 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 20px); position: relative; width: 20px; }", ".framer-ORLXf .framer-8oasec { flex: none; height: auto; position: relative; white-space: pre; width: auto; }", "@supports (background: -webkit-named-image(i)) and (not (font-palette:dark)) { .framer-ORLXf.framer-1rtq0nx, .framer-ORLXf .framer-14gp762, .framer-ORLXf .framer-19moii3 { gap: 0px; } .framer-ORLXf.framer-1rtq0nx > * { margin: 0px; margin-left: calc(20px / 2); margin-right: calc(20px / 2); } .framer-ORLXf.framer-1rtq0nx > :first-child, .framer-ORLXf .framer-19moii3 > :first-child { margin-left: 0px; } .framer-ORLXf.framer-1rtq0nx > :last-child, .framer-ORLXf .framer-19moii3 > :last-child { margin-right: 0px; } .framer-ORLXf .framer-14gp762 > * { margin: 0px; margin-bottom: calc(10px / 2); margin-top: calc(10px / 2); } .framer-ORLXf .framer-14gp762 > :first-child { margin-top: 0px; } .framer-ORLXf .framer-14gp762 > :last-child { margin-bottom: 0px; } .framer-ORLXf .framer-19moii3 > * { margin: 0px; margin-left: calc(12px / 2); margin-right: calc(12px / 2); } }", ".framer-ORLXf.framer-v-ldyh1u.framer-1rtq0nx { height: 62px; padding: 0px; width: 350px; }", ".framer-ORLXf.framer-v-ldyh1u .framer-14gp762 { padding: 20px; }", ".framer-ORLXf.framer-v-ldyh1u .framer-1s197uu-container, .framer-ORLXf.framer-v-ldyh1u .framer-8oasec { order: 0; }", ".framer-ORLXf.framer-v-ldyh1u .framer-19moii3, .framer-ORLXf.framer-v-ldyh1u .framer-12hme5w { order: 1; }", ...css, '.framer-ORLXf[data-border="true"]::after, .framer-ORLXf [data-border="true"]::after { content: ""; border-width: var(--border-top-width, 0) var(--border-right-width, 0) var(--border-bottom-width, 0) var(--border-left-width, 0); border-color: var(--border-color, none); border-style: var(--border-style, none); width: 100%; height: 100%; position: absolute; box-sizing: border-box; left: 0; top: 0; border-radius: inherit; pointer-events: none; }'];
...
}, ...SearchFonts, ...getFontsFromSharedStyle(fonts)], {
