 ...
 * @property {'First use-case' | 'Second use-case' | 'Third use-case'} [variant] - Variant
 */
...
var getProps = ({ height, id, sVGCode, text, title, width, ...props }) => {
	...
	return {
		...props,
		bnxxWw7CV:
			(_ref = text !== null && text !== void 0 ? text : props.bnxxWw7CV) !==
				null && _ref !== void 0
				? _ref
				: "Operate around the clock with the ability.",
		ICnfhZzNy:
			(_ref1 =
				sVGCode !== null && sVGCode !== void 0 ? sVGCode : props.ICnfhZzNy) !==
				null && _ref1 !== void 0
				? _ref1
		...
		PW_L6OdbJ:
			(_ref2 = title !== null && title !== void 0 ? title : props.PW_L6OdbJ) !==
				null && _ref2 !== void 0
				? _ref2
				: "Always On-Demand",
	};
...
/**
 * Renders UseCasesFramerComponent for all breakpoints with a variants map. Variant prop is inferred per breakpoint.
 * @function
 * @memberof UseCasesFramerComponent
...
var use_cases_default = ComponentWithRoot;
export { use_cases_default as default };
