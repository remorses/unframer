...
/waiter/`, {
  ...
  return <motion.div style={{
    ...
    "--framer-custom-placeholder-color": input.placeholderColor
  }} variants={formVariants} animate={formControls}>
				<form style={{
      width: "100%",
      height: "auto",
      display: "flex",
      ...
      gap: button.isDocked ? 0 : gap
					...
					{service === "getwaitlist" && <input type={"hidden"} name={"api_key"} value={getwaitlistAPI} />}
					{service === "convertkit" && <input type={"hidden"} name={"api_key"} value={convertkitAPI} />}
					<motion.input type={"email"} name={"email"} placeholder={input.placeholder} value={email} className={`${VERSION} framer-custom-input`} onChange={handleChange} onFocus={handleFocus} onBlur={handleBlur} autoComplete={"off"} autoCapitalize={"off"} autoCorrect={"off"} spellCheck={"false"} style={{
        ...defaultStyle,
        ...
        duration: 0.3
					...
					{!button.shouldAppear && isLoading && <Spinner shouldAppear={button.shouldAppear} paddingPerSide={paddingPerSide} paddingTop={paddingTop} paddingRight={paddingRight} padding={padding} color={input.color} />}
					{button.shouldAppear && <div style={{
    ...
    repeat: Infinity
      ...
      scale: 1
        ...
        color: props.color
					...
					<path d={"M 8 0 C 3.582 0 0 3.582 0 8 C 0 12.419 3.582 16 8 16 C 12.418 16 16 12.419 16 8 C 15.999 3.582 12.418 0 8 0 Z M 8 14 C 4.687 14 2 11.314 2 8 C 2 4.687 4.687 2 8 2 C 11.314 2 14 4.687 14 8 C 14 11.314 11.314 14 8 14 Z"} fill={"currentColor"} opacity={"0.2"} />
					<path d={"M 8 0 C 12.418 0 15.999 3.582 16 8 C 16 8 16 9 15 9 C 14 9 14 8 14 8 C 14 4.687 11.314 2 8 2 C 4.687 2 2 4.687 2 8 C 2 8 2 9 1 9 C 0 9 0 8 0 8 C 0 3.582 3.582 0 8 0 Z"} fill={"currentColor"} />
				</svg>
			</motion.div>
		</motion.div>;
};
  ...
  return <LayoutGroup id={layoutId ?? defaultLayoutId}>
			<Variants animate={variants} initial={false}>
				<Transition value={transition1}>
					<motion2.footer {...restProps} {...gestureHandlers} className={cx(scopingClassNames, "framer-1xyvahw", className5, classNames)} data-border={true} data-framer-name={"Desktop"} layoutDependency={layoutDependency} layoutId={"ByvYcqeqt"} ref={ref ?? ref1} style={{
            ...
            kdbCtkU1X: {
              background: {
                ...
                srcSet: "https://framerusercontent.com/images/yD0U6zt6U4ibtiPWyr1twxpY7M.jpg?scale-down-to=512 512w,https://framerusercontent.com/images/yD0U6zt6U4ibtiPWyr1twxpY7M.jpg?scale-down-to=1024 1024w,https://framerusercontent.com/images/yD0U6zt6U4ibtiPWyr1twxpY7M.jpg?scale-down-to=2048 2048w,https://framerusercontent.com/images/yD0U6zt6U4ibtiPWyr1twxpY7M.jpg 3840w"
						...
						<motion2.div className={"framer-4aroaq"} data-framer-name={"Container"} layoutDependency={layoutDependency} layoutId={"wBtGzI7cw"}>
							<motion2.div className={"framer-51n2j"} data-framer-name={"Logo + Socials"} layoutDependency={layoutDependency} layoutId={"kE9fURpZq"}>
								<ResolveLinks links={[{
                href: {
                  webPageId: "augiA20Il"
                },
                ...
                implicitPathVariables: void 0
                  ...
                  kdbCtkU1X: {
                    y: (componentViewport?.y || 0) + 64 + (((componentViewport?.height || 354) - 128 - 379) / 2 + 0 + 0) + 0 + 0 + 0 + 0
											...
											<SmartComponentScopedContainer className={"framer-2j1wk2-container"} layoutDependency={layoutDependency} layoutId={"MQUnesvFM-container"} nodeId={"MQUnesvFM"} rendersWithMotion={true} scopeId={"m5keEQA6U"}>
												{_jsx2(stdin_default, {
                      height: "100%",
                      id: "MQUnesvFM",
                      layoutId: "MQUnesvFM",
                      ...
                      ...addPropertyOverrides({
                        ...
                        kdbCtkU1X: {
                          ZceSIG0ZG: resolvedLinks[1]
							...
							<motion2.div className={"framer-1hjoplj"} data-framer-name={"Newsletter + Sitemap"} layoutDependency={layoutDependency} layoutId={"GQpNj2GWU"}>
								<motion2.div className={"framer-1qeoqxl"} data-framer-name={"Newsletter"} layoutDependency={layoutDependency} layoutId={"cFzxXrwyT"}>
									<motion2.div className={"framer-35bfwh"} data-framer-name={"Description"} layoutDependency={layoutDependency} layoutId={"uFzI4kgRx"}>
										<RichText __fromCanvasComponent={true} className={"framer-2q2c69"} fonts={["Inter"]} layoutDependency={layoutDependency} layoutId={"w2KLXvEhU"} style={{
                    ...
                    "--framer-paragraph-spacing": "0px"
                        ...
                        "--framer-text-color": "var(--extracted-r6o4lv, var(--token-a47e5f39-ab8e-4e9f-95d6-dca87be48225, rgb(255, 255, 255)))"
										...
										<RichText __fromCanvasComponent={true} className={"framer-q6t2vz"} fonts={["Inter"]} layoutDependency={layoutDependency} layoutId={"wmAxIojN6"} style={{
                    ...
                    "--framer-paragraph-spacing": "0px"
											...
											<React.Fragment>
												<motion2.p className={"framer-styles-preset-1fgmqi7"} data-styles-preset={"CWRpkcDNO"} style={{
                        "--framer-text-alignment": "left",
                        "--framer-text-color": "var(--extracted-r6o4lv, var(--token-19a7d54a-8908-466b-aff3-afd2d858cefc, rgba(255, 255, 255, 0.7)))"
									...
									<ComponentViewportProvider>
										<SmartComponentScopedContainer className={"framer-jwpma1-container"} isAuthoredByUser={true} isModuleExternal={true} layoutDependency={layoutDependency} layoutId={"f85CSRcw9-container"} nodeId={"f85CSRcw9"} rendersWithMotion={true} scopeId={"m5keEQA6U"}>
                      ...
                      width: "100%"
								...
								<motion2.div className={"framer-zm8v2b"} data-framer-name={"Sitemap"} layoutDependency={layoutDependency} layoutId={"FueLQooPm"}>
									<motion2.div className={"framer-1c57hm2"} data-framer-name={"Account"} layoutDependency={layoutDependency} layoutId={"CSxEK3_yc"}>
										<RichText __fromCanvasComponent={true} className={"framer-jdyvvx"} fonts={["Inter"]} layoutDependency={layoutDependency} layoutId={"TdJMUhpRm"} style={{
                    "--extracted-r6o4lv": "var(--token-a47e5f39-ab8e-4e9f-95d6-dca87be48225, rgb(255, 255, 255))",
                    "--framer-link-text-color": "rgb(0, 153, 255)",
                    "--framer-link-text-decoration": "underline",
                    "--framer-paragraph-spacing": "0px"
                        ...
                        "--framer-text-color": "var(--extracted-r6o4lv, var(--token-a47e5f39-ab8e-4e9f-95d6-dca87be48225, rgb(255, 255, 255)))"
										...
										<motion2.div className={"framer-h6pu6e"} data-framer-name={"Pages"} layoutDependency={layoutDependency} layoutId={"bMKfbJv7i"}>
											<RichText __fromCanvasComponent={true} className={"framer-6v65zf"} fonts={["Inter"]} layoutDependency={layoutDependency} layoutId={"uULMEi1eH"} style={{
                      "--framer-paragraph-spacing": "0px"
                    }} verticalAlignment={"top"} withExternalLayout={true}>
												<React.Fragment>
													<motion2.p className={"framer-styles-preset-14ew30v"} data-styles-preset={"TQvmJK7UB"}>
														<Link href={{
                            hash: ":tZ3Nk88mM",
                            webPageId: "augiA20Il"
                          }} nodeId={"uULMEi1eH"} openInNewTab={false} smoothScroll={true}>
															<motion2.a className={"framer-styles-preset-1fr0mxk"} data-styles-preset={"QqbrxlqQv"}>
																{"How It Works"}
															</motion2.a>
														</Link>
													</motion2.p>
											...
											<RichText __fromCanvasComponent={true} className={"framer-1w85510"} fonts={["Inter"]} layoutDependency={layoutDependency} layoutId={"bkierWyI1"} style={{
                      "--framer-paragraph-spacing": "0px"
                    }} verticalAlignment={"top"} withExternalLayout={true}>
												<React.Fragment>
													<motion2.p className={"framer-styles-preset-14ew30v"} data-styles-preset={"TQvmJK7UB"}>
                            ...
                            hash: ":sHnGLtvML",
                            webPageId: "augiA20Il"
                          }} nodeId={"bkierWyI1"} openInNewTab={false} smoothScroll={true}>
															<motion2.a className={"framer-styles-preset-1fr0mxk"} data-styles-preset={"QqbrxlqQv"}>
																{"Features"}
															</motion2.a>
														</Link>
											...
											<RichText __fromCanvasComponent={true} className={"framer-1mzz3wa"} fonts={["Inter"]} layoutDependency={layoutDependency} layoutId={"oDLvbqDww"} style={{
                      "--framer-paragraph-spacing": "0px"
                    }} verticalAlignment={"top"} withExternalLayout={true}>
												<React.Fragment>
													<motion2.p className={"framer-styles-preset-14ew30v"} data-styles-preset={"TQvmJK7UB"}>
                            ...
                            hash: ":jEif1shEi",
                            webPageId: "augiA20Il"
                          }} nodeId={"oDLvbqDww"} openInNewTab={false} smoothScroll={true}>
															<motion2.a className={"framer-styles-preset-1fr0mxk"} data-styles-preset={"QqbrxlqQv"}>
																{"Testimonials"}
															</motion2.a>
														</Link>
											...
											<RichText __fromCanvasComponent={true} className={"framer-149njf6"} fonts={["Inter"]} layoutDependency={layoutDependency} layoutId={"IWOXRQovK"} style={{
                      "--framer-paragraph-spacing": "0px"
                    }} verticalAlignment={"top"} withExternalLayout={true}>
												<React.Fragment>
													<motion2.p className={"framer-styles-preset-14ew30v"} data-styles-preset={"TQvmJK7UB"}>
                            ...
                            hash: ":NK_tcQhZf",
                            webPageId: "augiA20Il"
                          }} nodeId={"IWOXRQovK"} openInNewTab={false} smoothScroll={true}>
															<motion2.a className={"framer-styles-preset-1fr0mxk"} data-styles-preset={"QqbrxlqQv"}>
																{"Pricing"}
															</motion2.a>
														</Link>
									...
									<motion2.div className={"framer-1pw2j6z"} data-framer-name={"Information"} layoutDependency={layoutDependency} layoutId={"rLEHlxq9m"}>
										<RichText __fromCanvasComponent={true} className={"framer-1caedjc"} fonts={["Inter"]} layoutDependency={layoutDependency} layoutId={"NQGFDCmu2"} style={{
                    "--extracted-r6o4lv": "var(--token-a47e5f39-ab8e-4e9f-95d6-dca87be48225, rgb(255, 255, 255))",
                    "--framer-link-text-color": "rgb(0, 153, 255)",
                    "--framer-link-text-decoration": "underline",
                    "--framer-paragraph-spacing": "0px"
                        ...
                        "--framer-text-color": "var(--extracted-r6o4lv, var(--token-a47e5f39-ab8e-4e9f-95d6-dca87be48225, rgb(255, 255, 255)))"
										...
										<motion2.div className={"framer-w2wpd5"} data-framer-name={"Pages"} layoutDependency={layoutDependency} layoutId={"CRYUebkza"}>
											<RichText __fromCanvasComponent={true} className={"framer-1qpminj"} fonts={["Inter"]} layoutDependency={layoutDependency} layoutId={"WeHGfVy6R"} style={{
                      "--framer-paragraph-spacing": "0px"
                    }} verticalAlignment={"top"} withExternalLayout={true}>
												<React.Fragment>
													<motion2.p className={"framer-styles-preset-14ew30v"} data-styles-preset={"TQvmJK7UB"}>
                            ...
                            hash: ":g_GAoicEt",
                            webPageId: "augiA20Il"
                          }} nodeId={"WeHGfVy6R"} openInNewTab={false} smoothScroll={true}>
															<motion2.a className={"framer-styles-preset-1fr0mxk"} data-styles-preset={"QqbrxlqQv"}>
																{"FAQ"}
															</motion2.a>
														</Link>
											...
											<RichText __fromCanvasComponent={true} className={"framer-1kuie0d"} fonts={["Inter"]} layoutDependency={layoutDependency} layoutId={"i3B2JHop5"} style={{
                      "--framer-paragraph-spacing": "0px"
                    }} verticalAlignment={"top"} withExternalLayout={true}>
												<React.Fragment>
													<motion2.p className={"framer-styles-preset-14ew30v"} data-styles-preset={"TQvmJK7UB"}>
														<Link href={{
                            webPageId: "jg9o0Jk8V"
                          }} nodeId={"i3B2JHop5"} openInNewTab={false} smoothScroll={false}>
															<motion2.a className={"framer-styles-preset-1fr0mxk"} data-styles-preset={"QqbrxlqQv"}>
																{"Privacy"}
															</motion2.a>
														</Link>
											...
											<RichText __fromCanvasComponent={true} className={"framer-wpllre"} fonts={["Inter"]} layoutDependency={layoutDependency} layoutId={"A6S2uOeeN"} style={{
                      "--framer-paragraph-spacing": "0px"
                    }} verticalAlignment={"top"} withExternalLayout={true}>
												<React.Fragment>
													<motion2.p className={"framer-styles-preset-14ew30v"} data-styles-preset={"TQvmJK7UB"}>
														<Link href={{
                            webPageId: "TdQ_ISe7W"
                          }} nodeId={"A6S2uOeeN"} openInNewTab={false} smoothScroll={false}>
															<motion2.a className={"framer-styles-preset-1fr0mxk"} data-styles-preset={"QqbrxlqQv"}>
																{"404"}
															</motion2.a>
														</Link>
											...
											<RichText __fromCanvasComponent={true} className={"framer-1vzi2vs"} fonts={["Inter"]} layoutDependency={layoutDependency} layoutId={"EHNV3Abmg"} style={{
                      "--framer-paragraph-spacing": "0px"
                    }} verticalAlignment={"top"} withExternalLayout={true}>
												<React.Fragment>
													<motion2.p className={"framer-styles-preset-14ew30v"} data-styles-preset={"TQvmJK7UB"}>
														<Link href={{
                            webPageId: "YC1NE44pE"
                          }} nodeId={"EHNV3Abmg"} openInNewTab={false} smoothScroll={false}>
															<motion2.a className={"framer-styles-preset-1fr0mxk"} data-styles-preset={"QqbrxlqQv"}>
																{"Terms"}
															</motion2.a>
														</Link>
 ...
 * @function
 * @memberof SectionFooterFramerComponent
