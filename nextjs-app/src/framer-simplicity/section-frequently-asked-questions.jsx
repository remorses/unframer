...
var getProps = ({
	...
	return {
		...
		mDV6PtA6K:
			question5 ?? props.mDV6PtA6K ?? "What if I don't like the design?",
		oRIOycR3Y:
			answer2 ??
			props.oRIOycR3Y ??
		...
		pj8TaM0YQ:
			question3 ?? props.pj8TaM0YQ ?? "How fast will I receive my designs?",
		pOWJFdPGf:
			question6 ??
			props.pOWJFdPGf ??
		...
		variant:
			humanReadableVariantMap[props.variant] ?? props.variant ?? "pxzkAG2ht",
	};
};
							...
							background={{
								...
								loading: getLoadingLazyAtYPosition(
									(componentViewport?.y || 0) +
										((componentViewport?.height || 458) * 0.5000000000000002 -
											((componentViewport?.height || 458) * 1) / 2),
								),
								pixelHeight: 2160,
								pixelWidth: 3840,
								positionX: "center",
							...
							{...addPropertyOverrides(
								{
									BL9Xu_PHk: {
										background: {
											...
											loading: getLoadingLazyAtYPosition(
												(componentViewport?.y || 0) +
													((componentViewport?.height || 506) *
														0.5000000000000002 -
														((componentViewport?.height || 506) * 1) / 2),
											),
											pixelHeight: 2160,
											pixelWidth: 3840,
											positionX: "center",
									...
									CHJ1QtQsP: {
										background: {
											...
											loading: getLoadingLazyAtYPosition(
												(componentViewport?.y || 0) +
													((componentViewport?.height || 578) *
														0.5000000000000002 -
														((componentViewport?.height || 578) * 1) / 2),
											),
											pixelHeight: 2160,
											pixelWidth: 3840,
											positionX: "center",
											...
											loading: getLoadingLazyAtYPosition(
												(componentViewport?.y || 0) +
													((componentViewport?.height || 530) *
														0.5000000000000002 -
														((componentViewport?.height || 530) * 1) / 2),
											),
											pixelHeight: 2160,
											pixelWidth: 3840,
											positionX: "center",
...
var css3 = [
	...
	".framer-Ik33b.framer-ygixj1, .framer-Ik33b .framer-ygixj1 { display: block; }",
	".framer-Ik33b.framer-1fzreff { align-content: center; align-items: center; display: flex; flex-direction: column; flex-wrap: nowrap; gap: 35px; height: min-content; justify-content: center; max-width: 1100px; overflow: visible; padding: 0px; position: relative; width: 1100px; }",
	".framer-Ik33b .framer-1clz8o3 { flex: none; height: 100%; left: calc(50.00000000000002% - 100% / 2); overflow: visible; position: absolute; top: calc(50.00000000000002% - 100% / 2); width: 100%; z-index: 0; }",
	".framer-Ik33b .framer-fiabyb { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 16px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 100%; }",
	...
	".framer-Ik33b .framer-1wl4wu3, .framer-Ik33b .framer-fszf3v, .framer-Ik33b .framer-12f84d4, .framer-Ik33b .framer-1fntte0, .framer-Ik33b .framer-1yappud, .framer-Ik33b .framer-nf0jmc { flex: none; height: 12px; overflow: hidden; position: relative; width: 12px; }",
...
var getProps2 = ({ height, id, width, ...props }) => {
	return {
		...props,
		variant:
			humanReadableVariantMap2[props.variant] ?? props.variant ?? "g_GAoicEt",
	};
};
