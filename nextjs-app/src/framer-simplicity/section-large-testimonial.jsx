...
import { className as className2, css as css2, fonts as fonts2 } from "./chunks/chunk-HHDHZ6TZ.js";
...
// /:https://framerusercontent.com/modules/rcRkhs4bGTraIFq4gMc3/WWEquI82OywT67jASbI1/HOWKuDHCy.js
import { jsx as _jsx, jsxs as _jsxs } from "react/jsx-runtime";
import { addFonts, addPropertyControls, ComponentViewportProvider, ControlType, cx, getFonts, getFontsFromSharedStyle, RichText, SmartComponentScopedContainer, SVG, useComponentViewport, useLocaleInfo, useVariantState, withCSS, withFX, withOptimizedAppearEffect } from "unframer";
...
var cycleOrder = ["iB4cGAnq6", "UQjHTCbHp", "nzfsXBXZO"];
var serializationHash = "framer-lkMVE";
var variantClassNames = {
  iB4cGAnq6: "framer-v-1ky95h0",
  nzfsXBXZO: "framer-v-m7we1m",
  UQjHTCbHp: "framer-v-1gzxy6r"
};
...
var getProps = ({
  ...
  return {
    ...props,
    variant: humanReadableVariantMap[props.variant] ?? props.variant ?? "iB4cGAnq6"
  };
};
  ...
  return <LayoutGroup id={layoutId ?? defaultLayoutId}>
			<Variants animate={variants} initial={false}>
				<Transition value={transition1}>
					<motion.div {...restProps} {...gestureHandlers} className={cx(scopingClassNames, "framer-1ky95h0", className3, classNames)} data-framer-name={"Desktop"} layoutDependency={layoutDependency} layoutId={"iB4cGAnq6"} ref={ref ?? ref1} style={{
          ...
          UQjHTCbHp: {
            "data-framer-name": "Tablet"
						...
						<motion.div className={"framer-vrnr1w"} data-framer-name={"Container"} layoutDependency={layoutDependency} layoutId={"EJxnhumDM"}>
							<motion.div className={"framer-1qi96ef"} data-framer-name={"Content"} layoutDependency={layoutDependency} layoutId={"DUI6pBJN1"}>
								<motion.div className={"framer-16tvqdz"} data-framer-name={"Stars"} layoutDependency={layoutDependency} layoutId={"qD7PuQ4Xv"}>
									<ComponentViewportProvider>
										<SmartComponentScopedContainer className={"framer-11jouj7-container"} isAuthoredByUser={true} isModuleExternal={true} layoutDependency={layoutDependency} layoutId={"tO4MYTtCL-container"} nodeId={"tO4MYTtCL"} rendersWithMotion={true} scopeId={"HOWKuDHCy"}>
											<Icon color={"var(--token-310ebed3-699e-415f-a351-71fd111ec39a, rgba(255, 255, 255, 0.7))"} height={"100%"} iconSearch={"House"} iconSelection={"Star"} id={"tO4MYTtCL"} layoutId={"tO4MYTtCL"} mirrored={false} selectByList={true} style={{
                      height: "100%",
                      width: "100%"
                    }} weight={"fill"} width={"100%"} />
										</SmartComponentScopedContainer>
									</ComponentViewportProvider>
									<ComponentViewportProvider>
										<SmartComponentScopedContainer className={"framer-swc2x7-container"} isAuthoredByUser={true} isModuleExternal={true} layoutDependency={layoutDependency} layoutId={"pCVCYiMfa-container"} nodeId={"pCVCYiMfa"} rendersWithMotion={true} scopeId={"HOWKuDHCy"}>
											<Icon color={"var(--token-310ebed3-699e-415f-a351-71fd111ec39a, rgba(255, 255, 255, 0.7))"} height={"100%"} iconSearch={"House"} iconSelection={"Star"} id={"pCVCYiMfa"} layoutId={"pCVCYiMfa"} mirrored={false} selectByList={true} style={{
                      height: "100%",
                      width: "100%"
                    }} weight={"fill"} width={"100%"} />
										</SmartComponentScopedContainer>
									...
									<ComponentViewportProvider>
										<SmartComponentScopedContainer className={"framer-18e32rz-container"} isAuthoredByUser={true} isModuleExternal={true} layoutDependency={layoutDependency} layoutId={"F981hR5EO-container"} nodeId={"F981hR5EO"} rendersWithMotion={true} scopeId={"HOWKuDHCy"}>
											<Icon color={"var(--token-310ebed3-699e-415f-a351-71fd111ec39a, rgba(255, 255, 255, 0.7))"} height={"100%"} iconSearch={"House"} iconSelection={"Star"} id={"F981hR5EO"} layoutId={"F981hR5EO"} mirrored={false} selectByList={true} style={{
                      height: "100%",
                      width: "100%"
                    }} weight={"fill"} width={"100%"} />
										</SmartComponentScopedContainer>
									...
									<ComponentViewportProvider>
										<SmartComponentScopedContainer className={"framer-v6s7oy-container"} isAuthoredByUser={true} isModuleExternal={true} layoutDependency={layoutDependency} layoutId={"RdAPeaMt7-container"} nodeId={"RdAPeaMt7"} rendersWithMotion={true} scopeId={"HOWKuDHCy"}>
											<Icon color={"var(--token-310ebed3-699e-415f-a351-71fd111ec39a, rgba(255, 255, 255, 0.7))"} height={"100%"} iconSearch={"House"} iconSelection={"Star"} id={"RdAPeaMt7"} layoutId={"RdAPeaMt7"} mirrored={false} selectByList={true} style={{
                      height: "100%",
                      width: "100%"
                    }} weight={"fill"} width={"100%"} />
										</SmartComponentScopedContainer>
									...
									<ComponentViewportProvider>
										<SmartComponentScopedContainer className={"framer-z4mpyh-container"} isAuthoredByUser={true} isModuleExternal={true} layoutDependency={layoutDependency} layoutId={"BIREhT5ZL-container"} nodeId={"BIREhT5ZL"} rendersWithMotion={true} scopeId={"HOWKuDHCy"}>
											<Icon color={"var(--token-310ebed3-699e-415f-a351-71fd111ec39a, rgba(255, 255, 255, 0.7))"} height={"100%"} iconSearch={"House"} iconSelection={"Star"} id={"BIREhT5ZL"} layoutId={"BIREhT5ZL"} mirrored={false} selectByList={true} style={{
                      height: "100%",
                      width: "100%"
                    }} weight={"fill"} width={"100%"} />
										</SmartComponentScopedContainer>
								...
								<RichText __fromCanvasComponent={true} className={"framer-1dvn0mp"} fonts={["FS;Satoshi-medium"]} layoutDependency={layoutDependency} layoutId={"Hrh5SId0K"} style={{
                ...
                "--framer-link-text-decoration": "underline"
                    ...
                    "--framer-text-color": "var(--extracted-1of0zx5, var(--token-a47e5f39-ab8e-4e9f-95d6-dca87be48225, rgb(255, 255, 255)))"
								...
								<RichText __fromCanvasComponent={true} className={"framer-11chmli"} fonts={["Inter"]} layoutDependency={layoutDependency} layoutId={"PsNWUcutw"} style={{
                "--framer-link-text-color": "rgb(0, 153, 255)",
                "--framer-link-text-decoration": "underline"
              }} verticalAlignment={"top"} withExternalLayout={true}>
									<React.Fragment>
										<motion.p className={"framer-styles-preset-1o0gqap"} data-styles-preset={"YdlE6s2va"}>
											{"\u2014 Nils Kr\xF6ger from Workbase"}
										</motion.p>
									</React.Fragment>
								</RichText>
							</motion.div>
							<MotionDivWithFXWithOptimizedAppearEffect __perspectiveFX={false} __smartComponentFX={true} __targetOpacity={1} animate={animation} className={"framer-e3qeol"} data-framer-appear-id={"e3qeol"} data-framer-name={"Ticker"} initial={animation1} layoutDependency={layoutDependency} layoutId={"X_a_0Eqr9"} optimized={true}>
								<RichText __fromCanvasComponent={true} className={"framer-a625c0"} fonts={["Inter"]} layoutDependency={layoutDependency} layoutId={"sa34njZQp"} style={{
                "--framer-link-text-color": "rgb(0, 153, 255)",
                "--framer-link-text-decoration": "underline"
              }} verticalAlignment={"top"} withExternalLayout={true}>
									<React.Fragment>
...
var css3 = ["@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }", ".framer-lkMVE.framer-155kuwg, .framer-lkMVE .framer-155kuwg { display: block; }", ".framer-lkMVE.framer-1ky95h0 { align-content: center; align-items: center; display: flex; flex-direction: column; flex-wrap: nowrap; gap: 64px; height: min-content; justify-content: center; overflow: hidden; padding: 80px; position: relative; width: 1200px; }", ".framer-lkMVE .framer-vrnr1w { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 64px; height: min-content; justify-content: center; max-width: 1072px; overflow: visible; padding: 0px; position: relative; width: 100%; }", ".framer-lkMVE .framer-1qi96ef { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 32px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 100%; }", ".framer-lkMVE .framer-16tvqdz { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 4px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 100%; }", ".framer-lkMVE .framer-11jouj7-container, .framer-lkMVE .framer-swc2x7-container, .framer-lkMVE .framer-18e32rz-container, .framer-lkMVE .framer-v6s7oy-container, .framer-lkMVE .framer-z4mpyh-container { flex: none; height: 28px; position: relative; width: 28px; }", ".framer-lkMVE .framer-1dvn0mp { flex: none; height: auto; max-width: 673px; position: relative; white-space: pre-wrap; width: 100%; word-break: break-word; word-wrap: break-word; }", ".framer-lkMVE .framer-11chmli { flex: none; height: auto; max-width: 515px; position: relative; white-space: pre-wrap; width: 100%; word-break: break-word; word-wrap: break-word; }", ".framer-lkMVE .framer-e3qeol { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 16px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; scroll-margin-top: 150px; width: 100%; z-index: 1; }", ".framer-lkMVE .framer-a625c0 { flex: none; height: auto; position: relative; white-space: pre; width: auto; }", ".framer-lkMVE .framer-1mzb2ws-container { flex: none; height: 55px; max-width: 700px; position: relative; width: 100%; }", ".framer-lkMVE .framer-1moehjd { height: 20px; position: relative; width: 83px; }", ".framer-lkMVE .framer-as1h11 { height: 17px; position: relative; width: 146px; }", ".framer-lkMVE .framer-zouc92 { height: 16px; position: relative; width: 124px; }", ".framer-lkMVE .framer-irmrvw { height: 25px; position: relative; width: 95px; }", ".framer-lkMVE .framer-gst7rv { height: 23px; position: relative; width: 113px; }", "@supports (background: -webkit-named-image(i)) and (not (font-palette:dark)) { .framer-lkMVE.framer-1ky95h0, .framer-lkMVE .framer-vrnr1w, .framer-lkMVE .framer-1qi96ef, .framer-lkMVE .framer-16tvqdz, .framer-lkMVE .framer-e3qeol { gap: 0px; } .framer-lkMVE.framer-1ky95h0 > *, .framer-lkMVE .framer-vrnr1w > * { margin: 0px; margin-bottom: calc(64px / 2); margin-top: calc(64px / 2); } .framer-lkMVE.framer-1ky95h0 > :first-child, .framer-lkMVE .framer-vrnr1w > :first-child, .framer-lkMVE .framer-1qi96ef > :first-child, .framer-lkMVE .framer-e3qeol > :first-child { margin-top: 0px; } .framer-lkMVE.framer-1ky95h0 > :last-child, .framer-lkMVE .framer-vrnr1w > :last-child, .framer-lkMVE .framer-1qi96ef > :last-child, .framer-lkMVE .framer-e3qeol > :last-child { margin-bottom: 0px; } .framer-lkMVE .framer-1qi96ef > * { margin: 0px; margin-bottom: calc(32px / 2); margin-top: calc(32px / 2); } .framer-lkMVE .framer-16tvqdz > * { margin: 0px; margin-left: calc(4px / 2); margin-right: calc(4px / 2); } .framer-lkMVE .framer-16tvqdz > :first-child { margin-left: 0px; } .framer-lkMVE .framer-16tvqdz > :last-child { margin-right: 0px; } .framer-lkMVE .framer-e3qeol > * { margin: 0px; margin-bottom: calc(16px / 2); margin-top: calc(16px / 2); } }", ".framer-lkMVE.framer-v-1gzxy6r.framer-1ky95h0 { padding: 80px 32px 80px 32px; width: 810px; }", ".framer-lkMVE.framer-v-1gzxy6r .framer-11chmli, .framer-lkMVE.framer-v-m7we1m .framer-11chmli { --framer-text-wrap-override: balance; max-width: unset; }", ".framer-lkMVE.framer-v-m7we1m.framer-1ky95h0 { padding: 80px 24px 80px 24px; width: 390px; }", ".framer-lkMVE.framer-v-m7we1m .framer-11jouj7-container, .framer-lkMVE.framer-v-m7we1m .framer-swc2x7-container, .framer-lkMVE.framer-v-m7we1m .framer-18e32rz-container, .framer-lkMVE.framer-v-m7we1m .framer-v6s7oy-container, .framer-lkMVE.framer-v-m7we1m .framer-z4mpyh-container { height: 24px; width: 24px; }", ".framer-lkMVE.framer-v-m7we1m .framer-1dvn0mp { --framer-text-wrap: balance; max-width: unset; }", ".framer-lkMVE.framer-v-m7we1m .framer-a625c0 { white-space: pre-wrap; width: 277px; word-break: break-word; word-wrap: break-word; }", ...css2, ...css];
var FramerHOWKuDHCy = withCSS(Component, css3, "framer-lkMVE");
var stdin_default = FramerHOWKuDHCy;
FramerHOWKuDHCy.displayName = "Section Large Testimonial";
FramerHOWKuDHCy.defaultProps = {
  height: 620,
  width: 1200
};
addPropertyControls(FramerHOWKuDHCy, {
  variant: {
    options: ["iB4cGAnq6", "UQjHTCbHp", "nzfsXBXZO"],
    optionTitles: ["Desktop", "Tablet", "Phone"],
    title: "Variant",
    type: ControlType.Enum
  }
});
addFonts(FramerHOWKuDHCy, [{
  explicitInter: true,
  fonts: [{
    family: "Satoshi",
    source: "fontshare",
...
}, ...PhosphorFonts, ...TickerFonts, ...getFontsFromSharedStyle(fonts2), ...getFontsFromSharedStyle(fonts)], {
...
/**
 * Renders SectionLargeTestimonialFramerComponent for all breakpoints with a variants map. Variant prop is inferred per breakpoint.
 * @function
 * @memberof SectionLargeTestimonialFramerComponent
...
var section_large_testimonial_default = ComponentWithRoot;
export { section_large_testimonial_default as default };