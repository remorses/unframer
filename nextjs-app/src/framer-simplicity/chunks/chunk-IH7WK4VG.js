...
import { Children, useEffect, useState, useRef, useMemo, useCallback, cloneElement, startTransition } from "react";
...
function Ticker(props) {
  ...
  const measure = useCallback(() => {
    if (hasChildren && parentRef.current) {
      ...
      startTransition(() => setSize({ parent: parentLength, children: childrenLength }));
    }
  }, []);
