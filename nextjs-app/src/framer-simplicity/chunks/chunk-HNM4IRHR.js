...
var Component = /* @__PURE__ */ React.forwardRef(function (props, ref,) {
  ...
  const {
    ...
    setVariant,
    variants,
  } = useVariantState({ defaultVariant: 'mBaTZ1V5G', variant, variantClassNames, },);
      ...
      children: /* @__PURE__ */ _jsx(Transition, {
        ...
        children: /* @__PURE__ */ _jsx(Link, {
          ...
          children: /* @__PURE__ */ _jsx(motion.a, {
            ...restProps,
            ...gestureHandlers,
            className: `${cx(serializationHash, ...sharedStyleClassNames, 'framer-109qzaa', className, classNames,)} framer-iw0mdo`,
            ...
            children: /* @__PURE__ */ _jsx(Image, {
              background: {
                ...
                pixelHeight: 194,
                pixelWidth: 194,
                src: 'https://framerusercontent.com/images/NaTYhbpgrZOX1v374uYcigykZSs.png',
              },
              className: 'framer-1icj0ce',
              'data-framer-name': 'Logo (Replace)',
              layoutDependency,
              layoutId: 'xqae36yjY',
            },),
          },),
...
var css = [
  ...
  '.framer-Fikj6.framer-iw0mdo, .framer-Fikj6 .framer-iw0mdo { display: block; }',
  '.framer-Fikj6.framer-109qzaa { height: 24px; overflow: visible; position: relative; text-decoration: none; width: 24px; }',
  '.framer-Fikj6 .framer-1icj0ce { bottom: 0px; flex: none; left: 0px; overflow: visible; position: absolute; right: 0px; top: 0px; }',
];
