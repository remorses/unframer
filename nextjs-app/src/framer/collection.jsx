			...
			},
			{
				...
				[g]: (
					<i.Fragment>
						...
						<h2>{"Types of design portfolios"}</h2>
						<p>
							{
								...
								{(collection) =>
									collection.map(
										(
											...
											return (
												<LayoutGroup id={`y78Q_MgWu-${idy78Q_MgWu2}`}>
															...
															>
																<Image
																	background={{
																		...
																		fit: "fill",
																		sizes: "150px",
																		...toResponsiveImage(gxL3jPgQay78Q_MgWu2),
																	}}
...
/**
 * Renders CollectionFramerComponent for all breakpoints with a variants map. Variant prop is inferred per breakpoint.
 * @function
 * @memberof CollectionFramerComponent
...
var collection_default = ComponentWithRoot;
