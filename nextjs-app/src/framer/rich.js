...
// https :https://framerusercontent.com/modules/BOiZ9PHgH0ptXwEl9DVh/6VfL7xjVPXpQgbV9fFyB/ZpET7_TPl.js
...
var Component = /* @__PURE__ */ React.forwardRef(function (props2, ref,) {
  ...
  const { style, className: className8, layoutId, variant, Pzr5atV98, ...restProps } = getProps(props2,);
  ...
  const sharedStyleClassNames = [className3, className2, className6, className, className4, className5, className7,];
    ...
    children: /* @__PURE__ */ _jsx(Variants, {
      ...
      children: /* @__PURE__ */ _jsx(Transition, {
        ...
        children: /* @__PURE__ */ _jsx(motion.div, {
          ...restProps,
          ...gestureHandlers,
          className: cx(serializationHash, ...sharedStyleClassNames, 'framer-byvhuo', className8, classNames,),
...
addFonts(FramerinWBH4dIK, [
  ...
  ...((_componentPresets_fonts = fonts3) === null || _componentPresets_fonts === void 0 ? void 0 : _componentPresets_fonts['dPCM_W_tA'])
    ? getFontsFromComponentPreset(
      (_componentPresets_fonts1 = fonts3) === null || _componentPresets_fonts1 === void 0 ? void 0 : _componentPresets_fonts1['dPCM_W_tA'],
    )
    : [],
