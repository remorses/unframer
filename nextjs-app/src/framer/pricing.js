...
'use client';
import { className, className2, className3, css, css2, css3, fonts, fonts2, fonts3, } from './chunk-CQOEOO4E.js';
...
var locales = [];
stdin_default5.Responsive = ({ locale, ...props },) => {
...
function ComponentWithRoot({ locale, ...rest },) {
  return /* @__PURE__ */ jsx(WithRoot, { locale, children: /* @__PURE__ */ jsx(stdin_default5, { ...rest, },), },);
}
