...
// /:https://framerusercontent.com/modules/voblns21QvjoNLKdf1Tl/MAdFJXRr0B8qd1VFJisP/eaYqW6xw3.js
...
// /:https://framerusercontent.com/modules/lag7sUsQW69DzJd7WTvQ/FqKg8FgbkD1HBi1tn2Bb/cRmkgGutV.js
...
// /:https://framerusercontent.com/modules/rSbiLfsnHLTrF3vDy2qI/wwPZkJ3NWmc60aYUIYo1/eshFTHo2K.js
import { fontStore as fontStore2 } from "unframer";
fontStore2.loadWebFontsFromSelectors(["GF;DM Sans-regular"]);
var fonts4 = [
	{
		family: "DM Sans",
		moduleAsset: {
...
var className4 = "framer-kEfpu";

// /:https://framerusercontent.com/modules/naa0ugoTqrGMOULkYjia/aWdZ67n3P4gE06sKrUnR/cwMgH3g_H.js
var cycleOrder = ["TrJsulOOg", "y5k4iwWcs"];
var variantClassNames = {
	TrJsulOOg: "framer-v-1jux976",
	y5k4iwWcs: "framer-v-1y53r9x",
};
...
var humanReadableVariantMap = {
	"with Border": "TrJsulOOg",
	"without Border": "y5k4iwWcs",
};
var getProps = ({ feature, height, id, image, width, ...props }) => {
	...
	return {
		...
		Pb0KMdHqc:
			(ref =
				feature !== null && feature !== void 0 ? feature : props.Pb0KMdHqc) !==
				null && ref !== void 0
				? ref
		...
		variant:
			(ref1 =
				...
				: "TrJsulOOg",
		WEOMLUXiC:
			(ref2 = image !== null && image !== void 0 ? image : props.WEOMLUXiC) !==
				null && ref2 !== void 0
				? ref2
				: {
						src: new URL(
	...
	return (
		...
		>
			<motion.div
				...
				className={cx("framer-TUl5A", className4, classNames)}
				style={{
					display: "contents",
				}}
			>
...
addPropertyControls(FramercwMgH3g_H, {
	...
	Pb0KMdHqc: {
		defaultValue: "Phone & Priorty Support ",
	...
	WEOMLUXiC: {
		__defaultAssetReference:
			"data:framer/asset-reference,RDKpVNqV8WkmRY9WzAzpnJVkkI.svg?originalFilename=check.svg&preferredSize=auto",
		title: "Image",
		type: ControlType.ResponsiveImage,
	},
});
addFonts(FramercwMgH3g_H, [...fonts4]);
...
var variantClassNames2 = {
	"I167:27650;111:39602": "framer-v-1wvyaxi",
};
var transitions2 = {
	default: {
		damping: 60,
...
var getProps2 = ({ height, icon, id, title, width, ...props }) => {
	...
	return {
		...props,
		ksLTK3W4O:
			(ref = title !== null && title !== void 0 ? title : props.ksLTK3W4O) !==
				null && ref !== void 0
				? ref
				: "Better View",
		kYZr0S9qS:
			(ref1 = icon !== null && icon !== void 0 ? icon : props.kYZr0S9qS) !==
				null && ref1 !== void 0
				? ref1
				: {
						src: new URL(
				...
				<Transition2 value={transition}>
					<motion2.div
						...
						style={{
							"--border-bottom-width": "1px",
							"--border-color":
								'var(--token-64603892-5c8b-477a-82d6-e795e75dd5dc, rgb(23, 116, 242)) /* {"name":"Orange"} */',
...
FramerN3BIRIlrO.defaultProps = {
	height: 30,
	width: 118,
};
addPropertyControls2(FramerN3BIRIlrO, {
	ksLTK3W4O: {
		defaultValue: "Better View",
		displayTextArea: false,
		title: "Title",
...
var variantClassNames3 = {
	dIBDtF4lr: "framer-v-46k7fd",
	fMLzDPiVJ: "framer-v-106keaj",
};
...
var humanReadableVariantMap2 = {
	"Center Align": "dIBDtF4lr",
	"Left Align": "fMLzDPiVJ",
};
var getProps3 = ({
	description,
	height,
	...
	return {
		...
		ecriYSsUC:
			(ref =
				description !== null && description !== void 0
					? description
					: props.ecriYSsUC) !== null && ref !== void 0
				? ref
		...
		IaWp7lx6r:
			(ref1 = title !== null && title !== void 0 ? title : props.IaWp7lx6r) !==
				null && ref1 !== void 0
				? ref1
				: "A Mac app you\u2019ll \nlove to design with",
		moTqfDim_:
			(ref2 =
				tagText !== null && tagText !== void 0 ? tagText : props.moTqfDim_) !==
				null && ref2 !== void 0
				? ref2
				: "Better View",
		RemVozjsi:
			(ref3 =
				showBullet !== null && showBullet !== void 0
					? showBullet
					: props.RemVozjsi) !== null && ref3 !== void 0
				? ref3
				: true,
		SPRj6A3tJ:
			(ref4 =
				showDescription !== null && showDescription !== void 0
					? showDescription
					: props.SPRj6A3tJ) !== null && ref4 !== void 0
				? ref4
				: true,
		SU5SHTAmT:
			(ref5 =
				showTitle !== null && showTitle !== void 0
					? showTitle
					: props.SU5SHTAmT) !== null && ref5 !== void 0
				? ref5
				: true,
		UygWIK1Ch:
			(ref6 =
				tagIcon !== null && tagIcon !== void 0 ? tagIcon : props.UygWIK1Ch) !==
				null && ref6 !== void 0
				? ref6
				: {
						src: new URL(
		...
		variant:
			(ref7 =
				...
				_variant !== void 0
					? _variant
					: props.variant) !== null && ref7 !== void 0
				? ref7
				: "dIBDtF4lr",
	};
};
	...
	return (
		...
		>
			<motion3.div
				...
				className={cx3("framer-fSX7h", className3, className, classNames)}
				style={{
					display: "contents",
				}}
			>
...
addFonts3(FramerimqCP4fEz, [...TagFonts, ...fonts3, ...fonts]);

// /:https://framerusercontent.com/modules/1gobdaiETEZYApPHkFW8/RAQ43YyjZfCUTli605Pd/j1CXYH1vu.js
...
// /:https://framerusercontent.com/modules/irtADPc9MsWpaOZ5xWct/Cqtyndb7HgebXowgH7mP/tr0U97vbW.js
import { fontStore as fontStore3 } from "unframer";
fontStore3.loadWebFontsFromSelectors(["GF;DM Sans-500"]);
var fonts5 = [
	{
		family: "DM Sans",
		moduleAsset: {
...
var variantClassNames4 = {
	BM6EYWPbP: "framer-v-1vkpx8j",
	MHKwcgpiE: "framer-v-1fbf01a",
	nvj6GRWIN: "framer-v-1skui0i",
};
		...
		BQ8KjTU41:
			(_ref =
				rightIcon !== null && rightIcon !== void 0
					? rightIcon
					: props.BQ8KjTU41) !== null && _ref !== void 0
				? _ref
				: {
						src: "https://framerusercontent.com/images/QDgxMHJz2vKvFSMvhZpA6xplIBM.svg",
					},
		FOdt_Q22J:
			(_ref1 = title !== null && title !== void 0 ? title : props.FOdt_Q22J) !==
				null && _ref1 !== void 0
				? _ref1
				: "Get started now",
		gT8MXhd7P:
			(_ref2 =
				leftIcon !== null && leftIcon !== void 0
					? leftIcon
					: props.gT8MXhd7P) !== null && _ref2 !== void 0
				? _ref2
				: {
						src: "https://framerusercontent.com/images/QDgxMHJz2vKvFSMvhZpA6xplIBM.svg",
					},
		...
		wsxRD5u41:
			(_ref4 =
				showRightIcon !== null && showRightIcon !== void 0
					? showRightIcon
					: props.wsxRD5u41) !== null && _ref4 !== void 0
				? _ref4
				: true,
		...
		>
			<Variants animate={variants} initial={false}>
				<Transition4 value={transition}>
					<Link href={Xf0re2Pc_} openInNewTab={false} smoothScroll={true}>
						<motion4.a
							{...restProps}
							...
							style={{
								...
								"--border-top-width": "0px",
								backgroundColor:
									"var(--token-64603892-5c8b-477a-82d6-e795e75dd5dc, rgb(12, 64, 233))",
								borderBottomLeftRadius: 100,
								borderBottomRightRadius: 100,
								borderTopLeftRadius: 100,
								borderTopRightRadius: 100,
							...
							{...addPropertyOverrides3(
								{
									...
									MHKwcgpiE: {
										"data-framer-name": "Primary Smaller",
									},
								},
								baseVariant,
								gestureVariant,
...
var getProps5 = ({ buyEvent, height, id, width, ...props }) => {
	...
	return {
		...props,
		Gt9H5QhVm:
			buyEvent !== null && buyEvent !== void 0 ? buyEvent : props.Gt9H5QhVm,
		variant:
			(_ref =
				(_humanReadableVariantMap_props_variant =
						...
						>
											...
											<React5.Fragment>
												<motion5.h4
													...
													style={{
														"--framer-text-alignment": "left",
														"--framer-text-color":
															"var(--extracted-1eung3n, rgb(0, 0, 0))",
													}}
												>
													{"$14"}
												</motion5.h4>
									...
									<ComponentViewportProvider>
										...
										>
											{_jsx5(stdin_default4, {
												...
												id: "OsRPfjkAk",
												layoutId: "OsRPfjkAk",
												leftIcon: addImageAlt(
													{
														src: "https://framerusercontent.com/images/Nnev6aW8H97M9K6ID2XPXZqd0.svg",
													},
													"",
												),
												showLeftIcon: false,
							...
							<motion5.div
								...
								style={{
									"--border-bottom-width": "0px",
									"--border-color":
										'var(--token-64603892-5c8b-477a-82d6-e795e75dd5dc, rgb(255, 79, 0)) /* {"name":"Orange"} */',
									"--border-left-width": "0px",
									"--border-right-width": "0px",
									"--border-style": "solid",
