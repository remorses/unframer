...
'use client';
import { className, className2, className3, css, css2, css3, fonts, fonts2, fonts3, } from './chunks/chunk-PORUKG3Q.js';
...
var Component = /* @__PURE__ */ React.forwardRef(function (props, ref,) {
  ...
  const {
    ...
    setVariant,
    variants,
  } = useVariantState({ defaultVariant: 'gzT3814Te', variant, variantClassNames, },);
...
var css6 = [
  ...
  '.framer-LEQjH.framer-1rpsl5n, .framer-LEQjH .framer-1rpsl5n { display: block; }',
  '.framer-LEQjH.framer-2vg0ii { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: 31px; justify-content: center; overflow: visible; padding: 0px; position: relative; width: min-content; }',
  '.framer-LEQjH .framer-dwclm { flex: none; height: 43px; position: relative; width: 34px; }',
  '@supports (background: -webkit-named-image(i)) and (not (font-palette:dark)) { .framer-LEQjH.framer-2vg0ii { gap: 0px; } .framer-LEQjH.framer-2vg0ii > * { margin: 0px; margin-left: calc(0px / 2); margin-right: calc(0px / 2); } .framer-LEQjH.framer-2vg0ii > :first-child { margin-left: 0px; } .framer-LEQjH.framer-2vg0ii > :last-child { margin-right: 0px; } }',
];
