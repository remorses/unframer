...
import { addFonts, addPropertyControls as addPropertyControls2, ControlType as ControlType2, cx, getFonts, Image, RichText, useVariantState, withCSS } from "installable-framer/dist/framer";
...
function b2(n, e, t2, r2, o) {
  let i3, c, u2 = 0;
  do
    c = e + (t2 - e) / 2, i3 = s2(c, r2, o) - n, i3 > 0 ? t2 = c : e = c;
  while (Math.abs(i3) > f2 && ++u2 < d2);
  return c;
}
...
var F2 = { ease: l2(0.25, 0.1, 0.25, 1), "ease-in": l2(0.42, 0, 1, 1), "ease-in-out": l2(0.42, 0, 0.58, 1), "ease-out": l2(0, 0, 0.58, 1) };
var w = /\((.*?)\)/;
function l3(i3) {
  if (I(i3))
    return i3;
...
var T = class {
  constructor(t2, a2 = [0, 1], { easing: s3, duration: m2 = b.duration, delay: p2 = b.delay, endDelay: R3 = b.endDelay, repeat: A2 = b.repeat, offset: x2, direction: c = "normal" } = {}) {
    if (this.startTime = null, this.rate = 1, this.t = 0, this.cancelTimestamp = null, this.easing = u, this.duration = 0, this.totalDuration = 0, this.repeat = 0, this.playState = "idle", this.finished = new Promise((r2, h3) => {
    ...
    this.tick = (r2) => {
      ...
      p2 = p2;
      let e = 0;
      this.pauseTime !== void 0 ? e = this.pauseTime : e = (r2 - this.startTime) * this.rate, this.t = e, e /= 1e3, e = Math.max(e - p2, 0), this.playState === "finished" && this.pauseTime === void 0 && (e = this.totalDuration);
      ...
      t2(v2), this.pauseTime === void 0 && (this.playState === "finished" || e >= this.totalDuration + R3) ? (this.playState = "finished", (h3 = this.resolve) === null || h3 === void 0 || h3.call(this, v2)) : this.playState !== "idle" && (this.frameRequestId = requestAnimationFrame(this.tick));
    }, this.play();
  }
  play() {
...
var B = ({ stiffness: t2 = p.stiffness, damping: o = p.damping, mass: r2 = p.mass, from: s3 = 0, to: n = 1, velocity: i3 = 0, restSpeed: f3 = 2, restDistance: l4 = 0.5 } = {}) => {
  i3 = i3 ? N.s(i3) : 0;
  let c = { done: false, hasReachedTarget: false, current: s3, target: n }, h3 = n - s3, m2 = Math.sqrt(t2 / r2) / 1e3, a2 = w2(t2, o, r2), M2;
  if (a2 < 1) {
...
var L = ({ from: t2 = 0, velocity: o = 0, power: r2 = 0.8, decay: s3 = 0.325, bounceDamping: n, bounceStiffness: i3, changeTarget: f3, min: l4, max: c, restDistance: h3 = 0.5, restSpeed: m2 }) => {
  s3 = N.ms(s3);
  let a2 = { hasReachedTarget: false, done: false, current: t2, target: t2 }, M2 = (e) => l4 !== void 0 && e < l4 || c !== void 0 && e > c, u2 = (e) => l4 === void 0 ? c : c === void 0 || Math.abs(l4 - e) < Math.abs(c - e) ? l4 : c, d3 = r2 * o, R3 = t2 + d3, g2 = f3 === void 0 ? R3 : f3(R3);
  a2.target = g2, g2 !== R3 && (d3 = g2 - t2);
  let b3 = (e) => -d3 * Math.exp(-e / s3), q = (e) => g2 + b3(e), F4 = (e) => {
    let y = b3(e), k2 = q(e);
    a2.done = Math.abs(y) <= h3, a2.current = a2.done ? g2 : k2;
  }, x2, D, G2 = (e) => {
    M2(a2.current) && (x2 = e, D = B({ from: a2.current, to: u2(a2.current), velocity: T2(q, e, a2.current), damping: n, stiffness: i3, restDistance: h3, restSpeed: m2 }));
  };
  return G2(0), (e) => {
    let y = false;
    return !D && x2 === void 0 && (y = true, F4(e), G2(e)), x2 !== void 0 && e > x2 ? (a2.hasReachedTarget = true, D(e - x2)) : (a2.hasReachedTarget = false, !y && F4(e), a2);
  };
};
var V = 10;
var $ = 1e4;
...
var t = class {
  setAnimation(i3) {
    this.animation = i3, i3?.finished.then(() => this.clearAnimation()).catch(() => {
    });
  }
  clearAnimation() {
...
var It = { cssRegisterProperty: () => typeof CSS < "u" && Object.hasOwnProperty.call(CSS, "registerProperty"), waapi: () => Object.hasOwnProperty.call(Element.prototype, "animate"), partialKeyframes: () => {
  ...
  return true;
}, finished: () => !!lt({ opacity: [0, 1] }, { duration: 1e-3 }).finished, linearEasing: () => {
  try {
...
function _(t2, e, n, r2 = {}, o) {
  let i3 = We(), s3 = r2.record !== false && i3, l4, { duration: p2 = b.duration, delay: a2 = b.delay, endDelay: c = b.endDelay, repeat: d3 = b.repeat, easing: f3 = b.easing, persist: O3 = false, direction: S4, offset: m2, allowWebkitAcceleration: g2 = false } = r2, y = j2(t2), b3 = H(e), w3 = V2.waapi();
  b3 && Mt(t2, e);
  ...
  return J(A2.animation, !(F(f3) && A2.generator) && r2.record !== false), () => {
    ...
    }, u2 = _t(Y(n), h3), L2 = Q(u2, x2);
    if (F(f3)) {
      let v2 = f3.createAnimation(u2, e !== "opacity", h3, E2, A2);
      f3 = v2.easing, u2 = v2.keyframes || u2, p2 = v2.duration || p2;
    }
    if (R2(E2) && (V2.cssRegisterProperty() ? Nt(E2) : w3 = false), b3 && !V2.linearEasing() && (I(f3) || a(f3) && f3.some(I)) && (w3 = false), w3) {
      x2 && (u2 = u2.map((C) => s(C) ? x2.toDefaultUnit(C) : C)), u2.length === 1 && (!V2.partialKeyframes() || s3) && u2.unshift(h3());
      let v2 = { delay: N.ms(a2), duration: N.ms(p2), endDelay: N.ms(c), easing: a(f3) ? void 0 : ut(f3, p2), direction: S4, iterations: d3 + 1, fill: "both" };
      l4 = t2.animate({ [E2]: u2, offset: m2, easing: a(f3) ? f3.map((C) => ut(C, p2)) : void 0 }, v2), l4.finished || (l4.finished = new Promise((C, Z) => {
      ...
      u2 = u2.map((v2) => typeof v2 == "string" ? parseFloat(v2) : v2), u2.length === 1 && u2.unshift(parseFloat(h3())), l4 = new o((v2) => {
        M.set(t2, E2, L2 ? L2(v2) : v2);
      }, u2, Object.assign(Object.assign({}, r2), { duration: p2, easing: f3 }));
    else {
...
function P(t2, e) {
  var n;
  return typeof t2 == "string" ? e ? ((n = e[t2]) !== null && n !== void 0 || (e[t2] = document.querySelectorAll(t2)), t2 = e[t2]) : t2 = document.querySelectorAll(t2) : t2 instanceof Element && (t2 = [t2]), Array.from(t2 || []);
}
var Ne = (t2) => t2();
...
function et(t2) {
  ...
  return (n = {}) => {
    let r2 = /* @__PURE__ */ new Map(), o = (s3 = 0, l4 = 100, p2 = 0, a2 = false) => {
      let c = `${s3}-${l4}-${p2}-${a2}`;
      return r2.has(c) || r2.set(c, t2(Object.assign({ from: s3, to: l4, velocity: p2, restSpeed: a2 ? 0.05 : 2, restDistance: a2 ? 0.01 : 0.5 }, n))), r2.get(c);
    }, i3 = (s3, l4) => (e.has(s3) || e.set(s3, j(s3, l4)), e.get(s3));
    return { createAnimation: (s3, l4 = true, p2, a2, c) => {
      ...
      if (l4) {
        ...
        if (O3 = yt(y), g2 > 1 && s3[0] !== null)
          ...
          let b3 = c?.generator;
          if (b3) {
            let { animation: w3, generatorStartTime: E2 } = c, A2 = w3?.startTime || E2 || 0, x2 = w3?.currentTime || performance.now() - A2, h3 = b3(x2).current;
      ...
      if (Gt(f3) && Gt(O3)) {
        ...
        d3 = Object.assign(Object.assign({}, i3(y, m2)), { easing: "linear" }), c && (c.generator = y, c.generatorStartTime = performance.now());
      }
...
function xt(t2, e, { root: n, margin: r2, amount: o = "any" } = {}) {
  ...
  let i3 = P(t2), s3 = /* @__PURE__ */ new WeakMap(), l4 = (a2) => {
    a2.forEach((c) => {
...
function Sn({ target: t2, contentRect: e, borderBoxSize: n }) {
  ...
  (r2 = nt.get(t2)) === null || r2 === void 0 || r2.forEach((o) => {
    o({ target: t2, contentSize: e, get size() {
      return En(t2, n);
    } });
  });
}
...
var ce = { isActive: (t2) => !!t2.inView, subscribe: (t2, { enable: e, disable: n }, { inViewOptions: r2 = {} }) => {
...
var le = { isActive: (t2) => !!t2.hover, subscribe: (t2, { enable: e, disable: n }) => {
...
var me = { isActive: (t2) => !!t2.press, subscribe: (t2, { enable: e, disable: n }) => {
  let r2 = (i3) => {
...
function Ticker(props) {
  ...
  if (hasChildren) {
    ...
    clonedChildren = Children.map(slots, (child, index) => {
      ...
      return /* @__PURE__ */ _jsx(LayoutGroup, { inherit: "id", children: /* @__PURE__ */ _jsx("li", { ref: ref4, style: size2, children: /* @__PURE__ */ cloneElement(child, { style: { ...(ref2 = child.props) === null || ref2 === void 0 ? void 0 : ref2.style, ...size2, flexShrink: 0, ...childrenStyles }, layoutId: void 0 }, (ref3 = child.props) === null || ref3 === void 0 ? void 0 : ref3.children) }) });
    });
  }
  if (!isCanvas) {
    for (let i3 = 0; i3 < duplicateBy; i3++) {
      dupedChildren = [...dupedChildren, ...Children.map(slots, (child, childIndex) => {
        var ref, ref1, ref2, ref3;
        return /* @__PURE__ */ _jsx(LayoutGroup, { inherit: "id", children: /* @__PURE__ */ _jsx("li", { style: { display: "contents" }, "aria-hidden": true, children: /* @__PURE__ */ cloneElement(child, { key: i3 + " " + childIndex, style: { ...(ref = child.props) === null || ref === void 0 ? void 0 : ref.style, width: widthType ? (ref1 = child.props) === null || ref1 === void 0 ? void 0 : ref1.width : "100%", height: heightType ? (ref2 = child.props) === null || ref2 === void 0 ? void 0 : ref2.height : "100%", flexShrink: 0, ...childrenStyles }, layoutId: void 0 }, (ref3 = child.props) === null || ref3 === void 0 ? void 0 : ref3.children) }, i3 + "li" + childIndex) }, i3 + "lg" + childIndex);
      })];
    }
  }
...
var Component = /* @__PURE__ */ React.forwardRef(function({ id, style, className, width, height, layoutId, variant: outerVariant = "GSFRnChFA", ...restProps }, ref) {
  ...
  return /* @__PURE__ */ _jsx2(LayoutGroup2, { id: layoutId !== null && layoutId !== void 0 ? layoutId : defaultLayoutId, children: /* @__PURE__ */ _jsx2(motion2.div, { initial: variant, animate: variants, onHoverStart: () => setGestureState({ isHovered: true }), onHoverEnd: () => setGestureState({ isHovered: false }), onTapStart: () => setGestureState({ isPressed: true }), onTap: () => setGestureState({ isPressed: false }), onTapCancel: () => setGestureState({ isPressed: false }), className: cx("framer-d7otB", classNames), style: { display: "contents" }, children: /* @__PURE__ */ _jsxs2(motion2.div, { ...restProps, className: cx("framer-uvc2d5", className), "data-framer-name": "Logo Ticker", layoutDependency, layoutId: "GSFRnChFA", ref, style: { opacity: 0.6, ...style }, transition, ...addPropertyOverrides({ l9f6iav4R: { "data-framer-name": "Logo Ticker - M" } }, baseVariant, gestureVariant), children: [/* @__PURE__ */ _jsx2(RichText, { __fromCanvasComponent: true, children: /* @__PURE__ */ _jsx2(React.Fragment, { children: /* @__PURE__ */ _jsx2(motion2.p, { style: { "--font-selector": "SW50ZXItQm9sZA==", "--framer-font-family": '"Inter-Bold", "Inter", "Inter Placeholder", sans-serif', "--framer-font-weight": "700", "--framer-letter-spacing": "-0.2px", "--framer-text-color": "var(--extracted-r6o4lv)" }, children: /* @__PURE__ */ _jsx2(motion2.span, { "data-text-fill": "true", style: { backgroundImage: "linear-gradient(90deg, rgb(21, 132, 235) 0%, rgb(36, 214, 217) 100%)" }, children: "Featured by" }) }) }), className: "framer-kqr5os", fonts: ["Inter-Bold"], layoutDependency, layoutId: "XfndhbYr8", style: { "--extracted-r6o4lv": "var(--token-15fc6ab8-c2ea-472c-853a-fd5eab1ecf4a, rgba(10, 10, 13, 0.6))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--framer-paragraph-spacing": "0px", opacity: 0 }, transformTemplate, transition, verticalAlignment: "top", withExternalLayout: true }), /* @__PURE__ */ _jsx2(motion2.div, { className: "framer-33yjyg", "data-framer-name": "Ticker Container", layoutDependency, layoutId: "DIozXdNnd", transition, children: /* @__PURE__ */ _jsx2(motion2.div, { className: "framer-aj5tiq-container", layoutDependency, layoutId: "LY9zg3llC-container", transition, children: /* @__PURE__ */ _jsx2(Ticker, { alignment: "center", direction: "left", fadeOptions: { fadeAlpha: 0, fadeContent: true, fadeInset: 0, fadeWidth: 25, overflow: false }, gap: 48, height: "100%", hoverFactor: 0.5, id: "LY9zg3llC", layoutId: "LY9zg3llC", padding: 10, paddingBottom: 10, paddingLeft: 10, paddingPerSide: false, paddingRight: 10, paddingTop: 10, sizingOptions: { heightType: true, widthType: true }, slots: [/* @__PURE__ */ _jsx2(Image, { background: { alt: "", fit: "fill", intrinsicHeight: 56, intrinsicWidth: 214, pixelHeight: 56, pixelWidth: 214, src: new URL("assets/2MRVAPOv5JgK3XywRONSUaIKqk.png", "https://framerusercontent.com/modules/r0GBH7SiUQiS6ZBqAeSA/YtVlixDzOkypVBs3Dpav/F1yUSD211.js").href }, className: "framer-ho7oum", "data-framer-name": "ticker6", layoutDependency, layoutId: "wIBpL1t1o", transition }), /* @__PURE__ */ _jsx2(Image, { background: { alt: "", fit: "fill", intrinsicHeight: 56, intrinsicWidth: 266, pixelHeight: 56, pixelWidth: 266, src: new URL("assets/AWy6GJFmKZrXWU757K5RoZkK3g.png", "https://framerusercontent.com/modules/r0GBH7SiUQiS6ZBqAeSA/YtVlixDzOkypVBs3Dpav/F1yUSD211.js").href }, className: "framer-m43icu", "data-framer-name": "ticker5", layoutDependency, layoutId: "DiDAbjJRO", transition }), /* @__PURE__ */ _jsx2(Image, { background: { alt: "", fit: "fill", intrinsicHeight: 56, intrinsicWidth: 175, pixelHeight: 56, pixelWidth: 175, src: new URL("assets/rZQaW9lAvPXMyLnVeXIW6OB7mA.png", "https://framerusercontent.com/modules/r0GBH7SiUQiS6ZBqAeSA/YtVlixDzOkypVBs3Dpav/F1yUSD211.js").href }, className: "framer-1lkiw69", "data-framer-name": "ticker4", layoutDependency, layoutId: "H2SK1ImTm", transition }), /* @__PURE__ */ _jsx2(Image, { background: { alt: "", fit: "fill", intrinsicHeight: 56, intrinsicWidth: 241, pixelHeight: 56, pixelWidth: 241, src: new URL("assets/Q10yYhvk0MrTo7QY1DcHQgJMo.png", "https://framerusercontent.com/modules/r0GBH7SiUQiS6ZBqAeSA/YtVlixDzOkypVBs3Dpav/F1yUSD211.js").href }, className: "framer-1pkn5xg", "data-framer-name": "ticker3", layoutDependency, layoutId: "ccoKfMTwo", transition }), /* @__PURE__ */ _jsx2(Image, { background: { alt: "", fit: "fill", intrinsicHeight: 56, intrinsicWidth: 202, pixelHeight: 56, pixelWidth: 202, src: new URL("assets/ppxS5gb3Cz9F0carwvkiKmJGAU.png", "https://framerusercontent.com/modules/r0GBH7SiUQiS6ZBqAeSA/YtVlixDzOkypVBs3Dpav/F1yUSD211.js").href }, className: "framer-1r2h739", "data-framer-name": "ticker2", layoutDependency, layoutId: "JoXhu8PjD", transition }), /* @__PURE__ */ _jsx2(Image, { background: { alt: "", fit: "fill", intrinsicHeight: 56, intrinsicWidth: 218, pixelHeight: 56, pixelWidth: 218, src: new URL("assets/UDE4FbyVmBdXLpobJWNt4qebTHA.png", "https://framerusercontent.com/modules/r0GBH7SiUQiS6ZBqAeSA/YtVlixDzOkypVBs3Dpav/F1yUSD211.js").href }, className: "framer-1zxwag", "data-framer-name": "ticker1", layoutDependency, layoutId: "D0cqPvsIH", transition })], speed: 75, style: { height: "100%", width: "100%" }, width: "100%" }) }) })] }) }) });
});
var css = ['.framer-d7otB [data-border="true"]::after { content: ""; border-width: var(--border-top-width, 0) var(--border-right-width, 0) var(--border-bottom-width, 0) var(--border-left-width, 0); border-color: var(--border-color, none); border-style: var(--border-style, none); width: 100%; height: 100%; position: absolute; box-sizing: border-box; left: 0; top: 0; border-radius: inherit; pointer-events: none; }', "@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }", ".framer-d7otB .framer-154d70i { display: block; }", ".framer-d7otB .framer-uvc2d5 { align-content: center; align-items: center; display: flex; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: 32px; justify-content: center; overflow: hidden; padding: 32px 16px 32px 16px; position: relative; width: 708px; }", ".framer-d7otB .framer-kqr5os { flex: none; height: auto; left: 50%; position: absolute; top: 50%; white-space: pre; width: auto; z-index: 1; }", ".framer-d7otB .framer-33yjyg { flex: none; height: 200px; overflow: visible; position: relative; width: 676px; }", ".framer-d7otB .framer-aj5tiq-container { bottom: 0px; flex: none; left: 0px; position: absolute; right: 0px; top: 0px; }", ".framer-d7otB .framer-ho7oum { aspect-ratio: 3.8214285714285716 / 1; height: var(--framer-aspect-ratio-supported, 24px); overflow: visible; position: relative; width: 92px; }", ".framer-d7otB .framer-m43icu { aspect-ratio: 4.75 / 1; height: var(--framer-aspect-ratio-supported, 24px); overflow: visible; position: relative; width: 114px; }", ".framer-d7otB .framer-1lkiw69 { aspect-ratio: 3.125 / 1; height: var(--framer-aspect-ratio-supported, 24px); overflow: visible; position: relative; width: 75px; }", ".framer-d7otB .framer-1pkn5xg { aspect-ratio: 4.303571428571429 / 1; height: var(--framer-aspect-ratio-supported, 24px); overflow: visible; position: relative; width: 103px; }", ".framer-d7otB .framer-1r2h739 { aspect-ratio: 3.607142857142857 / 1; height: var(--framer-aspect-ratio-supported, 24px); overflow: visible; position: relative; width: 87px; }", ".framer-d7otB .framer-1zxwag { aspect-ratio: 3.892857142857143 / 1; height: var(--framer-aspect-ratio-supported, 24px); overflow: visible; position: relative; width: 93px; }", "@supports (background: -webkit-named-image(i)) and (not (font-palette:dark)) { .framer-d7otB .framer-uvc2d5 { gap: 0px; } .framer-d7otB .framer-uvc2d5 > * { margin: 0px; margin-bottom: calc(10px / 2); margin-top: calc(10px / 2); } .framer-d7otB .framer-uvc2d5 > :first-child { margin-top: 0px; } .framer-d7otB .framer-uvc2d5 > :last-child { margin-bottom: 0px; } }", ".framer-d7otB.framer-v-1w9d22v .framer-uvc2d5 { gap: 0px; height: 96px; padding: 32px 0px 32px 0px; width: 359px; }", ".framer-d7otB.framer-v-1w9d22v .framer-33yjyg { width: 100%; }", "@supports (background: -webkit-named-image(i)) and (not (font-palette:dark)) { .framer-d7otB.framer-v-1w9d22v .framer-uvc2d5 { gap: 0px; } .framer-d7otB.framer-v-1w9d22v .framer-uvc2d5 > * { margin: 0px; margin-bottom: calc(0px / 2); margin-top: calc(0px / 2); } .framer-d7otB.framer-v-1w9d22v .framer-uvc2d5 > :first-child { margin-top: 0px; } .framer-d7otB.framer-v-1w9d22v .framer-uvc2d5 > :last-child { margin-bottom: 0px; } }"];
...
var __FramerMetadata__ = { "exports": { "default": { "type": "reactComponent", "name": "FramerF1yUSD211", "slots": [], "annotations": { "framerIntrinsicHeight": "64", "framerContractVersion": "1", "framerCanvasComponentVariantDetails": '{"propertyName":"variant","data":{"default":{"layout":["fixed","fixed"]},"l9f6iav4R":{"layout":["fixed","fixed"]}}}', "framerIntrinsicWidth": "708" } }, "Props": { "type": "tsType", "annotations": { "framerContractVersion": "1" } }, "__FramerMetadata__": { "type": "variable" } } };
export {
  __FramerMetadata__,
