...
var variantClassNames = {
	HADfUKD9c: "framer-v-1r2g3dq",
	sqZIXSHj4: "framer-v-1d6b55l",
	yGwCuCsVV: "framer-v-hf084k",
};
...
var getProps = ({ height, id, inputName, width, ...props }) => {
	...
	return {
		...
		OyNURvO2c:
			(_ref =
				inputName !== null && inputName !== void 0
					? inputName
					: props.OyNURvO2c) !== null && _ref !== void 0
				? _ref
				: "Email",
		variant:
			(_ref1 =
...
var Component = /* @__PURE__ */ React.forwardRef(function (props, ref) {
	...
	const { style, className, layoutId, variant, OyNURvO2c, ...restProps } =
		getProps(props);
	const {
		baseVariant,
		classNames,
	...
	const onBlur1g587fv = activeVariantCallback(async (...args) => {
		...
		const inputValue =
			(_args_ = args[0]) === null || _args_ === void 0
				? void 0
				: (_args__target = _args_.target) === null || _args__target === void 0
					? void 0
					: (_args__target_value = _args__target.value) === null ||
							_args__target_value === void 0
						? void 0
